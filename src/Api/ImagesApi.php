...
class ImagesApi
{
     ...
     * Image Create
     *
     * @param  \ZoneWatcher\LinodeApiV4\Model\UNKNOWN_BASE_TYPE $unknown_base_type Information about the Image to create. (optional)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\Image|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function createImage($unknown_base_type = null)
    {
        list($response) = $this->createImageWithHttpInfo($unknown_base_type);
        return $response;
    }
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\Image|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function createImageWithHttpInfo($unknown_base_type = null)
    {
        $request = $this->createImageRequest($unknown_base_type);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\Image' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\Image', []),
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\Image';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\Image',
     ...
     */
    public function createImageAsync($unknown_base_type = null)
    {
        return $this->createImageAsyncWithHttpInfo($unknown_base_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createImageAsyncWithHttpInfo($unknown_base_type = null)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\Image';
        $request = $this->createImageRequest($unknown_base_type);
     ...
     */
    public function createImageRequest($unknown_base_type = null)
    {
     ...
     * Image Delete
     *
     * @param  string $image_id ID of the Image to look up. (required)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $request = $this->deleteImageRequest($image_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteImageAsync($image_id)
    {
        return $this->deleteImageAsyncWithHttpInfo($image_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteImageAsyncWithHttpInfo($image_id)
    {
        $returnType = 'object';
        $request = $this->deleteImageRequest($image_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteImageRequest($image_id)
    {
    ...
    {
        list($response) = $this->getImageWithHttpInfo($image_id);
        return $response;
    }
     ...
     * @return array of \ZoneWatcher\LinodeApiV4\Model\Image|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getImageWithHttpInfo($image_id)
    {
        $request = $this->getImageRequest($image_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImageAsync($image_id)
    {
        return $this->getImageAsyncWithHttpInfo($image_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImageAsyncWithHttpInfo($image_id)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\Image';
        $request = $this->getImageRequest($image_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getImageRequest($image_id)
    {
        // verify the required parameter 'image_id' is set
        if ($image_id === null || (is_array($image_id) && count($image_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\InlineResponse20015|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function getImages($page = 1, $page_size = 100)
    {
        list($response) = $this->getImagesWithHttpInfo($page, $page_size);
        return $response;
    }
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\InlineResponse20015|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getImagesWithHttpInfo($page = 1, $page_size = 100)
    {
        $request = $this->getImagesRequest($page, $page_size);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\InlineResponse20015' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20015', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20015';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20015',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImagesAsync($page = 1, $page_size = 100)
    {
        return $this->getImagesAsyncWithHttpInfo($page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getImagesAsyncWithHttpInfo($page = 1, $page_size = 100)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20015';
        $request = $this->getImagesRequest($page, $page_size);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getImagesRequest($page = 1, $page_size = 100)
    {
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling ImagesApi.getImages, must be bigger than or equal to 1.');
        }
        ...
        if ($page_size !== null && $page_size < 25) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling ImagesApi.getImages, must be bigger than or equal to 25.');
        }
     ...
     *
     * @param  \ZoneWatcher\LinodeApiV4\Model\InlineObject5 $inline_object5 inline_object5 (optional)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\InlineResponse20016|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function imagesUploadPost($inline_object5 = null)
    {
        list($response) = $this->imagesUploadPostWithHttpInfo($inline_object5);
        return $response;
    }

    /**
     * Operation imagesUploadPostWithHttpInfo
     *
     * Image Upload
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * URL: https://api.linode.com/v4beta
     *
     * @param  \ZoneWatcher\LinodeApiV4\Model\InlineObject5 $inline_object5 (optional)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\InlineResponse20016|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function imagesUploadPostWithHttpInfo($inline_object5 = null)
    {
        $request = $this->imagesUploadPostRequest($inline_object5);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\InlineResponse20016' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20016', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20016';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20016',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation imagesUploadPostAsync
     *
     * Image Upload
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imagesUploadPostAsync($inline_object5 = null)
    {
        return $this->imagesUploadPostAsyncWithHttpInfo($inline_object5)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation imagesUploadPostAsyncWithHttpInfo
     *
     * Image Upload
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function imagesUploadPostAsyncWithHttpInfo($inline_object5 = null)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20016';
        $request = $this->imagesUploadPostRequest($inline_object5);
    ...
    /**
     * Create request for operation 'imagesUploadPost'
     *
     * This operation contains host(s) defined in the OpenAP spec. Use 'hostIndex' to select the host.
     * URL: https://api.linode.com/v4
     * URL: https://api.linode.com/v4beta
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function imagesUploadPostRequest($inline_object5 = null)
    {

        $resourcePath = '/images/upload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $operationHosts = ["https://api.linode.com/v4", "https://api.linode.com/v4beta"];
     ...
     *
     * @param  string $image_id ID of the Image to look up. (required)
     * @param  \ZoneWatcher\LinodeApiV4\Model\Image $image The fields to update. (required)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\Image|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
    ...
    {
        list($response) = $this->updateImageWithHttpInfo($image_id, $image);
        return $response;
    }
     ...
     * @return array of \ZoneWatcher\LinodeApiV4\Model\Image|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateImageWithHttpInfo($image_id, $image)
    {
        $request = $this->updateImageRequest($image_id, $image);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateImageAsync($image_id, $image)
    {
        return $this->updateImageAsyncWithHttpInfo($image_id, $image)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateImageAsyncWithHttpInfo($image_id, $image)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\Image';
        $request = $this->updateImageRequest($image_id, $image);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateImageRequest($image_id, $image)
    {
        // verify the required parameter 'image_id' is set
        if ($image_id === null || (is_array($image_id) && count($image_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($image === null || (is_array($image) && count($image) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $image when calling updateImage'
            );
        }
        ...
        if (isset($image)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($image));
            } else {
                $httpBody = $image;
            }
        } elseif (count($formParams) > 0) {
