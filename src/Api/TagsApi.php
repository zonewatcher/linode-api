...
class TagsApi
{
     ...
     * New Tag Create
     *
     * @param  \ZoneWatcher\LinodeApiV4\Model\InlineObject17 $inline_object17 inline_object17 (optional)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\Tag|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function createTag($inline_object17 = null)
    {
        list($response) = $this->createTagWithHttpInfo($inline_object17);
        return $response;
    }
     ...
     * New Tag Create
     *
     * @param  \ZoneWatcher\LinodeApiV4\Model\InlineObject17 $inline_object17 (optional)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\Tag|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function createTagWithHttpInfo($inline_object17 = null)
    {
        $request = $this->createTagRequest($inline_object17);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\Tag' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\Tag', []),
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\Tag';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\Tag',
     ...
     */
    public function createTagAsync($inline_object17 = null)
    {
        return $this->createTagAsyncWithHttpInfo($inline_object17)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createTagAsyncWithHttpInfo($inline_object17 = null)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\Tag';
        $request = $this->createTagRequest($inline_object17);
     ...
     */
    public function createTagRequest($inline_object17 = null)
    {
    ...
    {
        list($response) = $this->deleteTagWithHttpInfo($label);
        return $response;
    }
     ...
     */
    public function deleteTagWithHttpInfo($label)
    {
        $request = $this->deleteTagRequest($label);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTagAsync($label)
    {
        return $this->deleteTagAsyncWithHttpInfo($label)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTagAsyncWithHttpInfo($label)
    {
        $returnType = 'object';
        $request = $this->deleteTagRequest($label);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTagRequest($label)
    {
        // verify the required parameter 'label' is set
        if ($label === null || (is_array($label) && count($label) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $label when calling deleteTag'
            );
        }

        $resourcePath = '/tags/{label}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return object|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function getTaggedObjects($label, $page = 1, $page_size = 100)
    {
        list($response) = $this->getTaggedObjectsWithHttpInfo($label, $page, $page_size);
        return $response;
    }

    /**
     * Operation getTaggedObjectsWithHttpInfo
     *
     * Tagged Objects List
     *
     * @param  string $label (required)
     ...
     * @return array of object|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTaggedObjectsWithHttpInfo($label, $page = 1, $page_size = 100)
    {
        $request = $this->getTaggedObjectsRequest($label, $page, $page_size);
    ...
    /**
     * Operation getTaggedObjectsAsync
     *
     * Tagged Objects List
     *
     * @param  string $label (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaggedObjectsAsync($label, $page = 1, $page_size = 100)
    {
        return $this->getTaggedObjectsAsyncWithHttpInfo($label, $page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTaggedObjectsAsyncWithHttpInfo
     *
     * Tagged Objects List
     *
     * @param  string $label (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTaggedObjectsAsyncWithHttpInfo($label, $page = 1, $page_size = 100)
    {
        $returnType = 'object';
        $request = $this->getTaggedObjectsRequest($label, $page, $page_size);
    ...
    /**
     * Create request for operation 'getTaggedObjects'
     *
     * @param  string $label (required)
     * @param  int $page The page of a collection to return. (optional, default to 1)
     * @param  int $page_size The number of items to return per page. (optional, default to 100)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTaggedObjectsRequest($label, $page = 1, $page_size = 100)
    {
        // verify the required parameter 'label' is set
        if ($label === null || (is_array($label) && count($label) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $label when calling getTaggedObjects'
            );
        }
        if ($page !== null && $page < 1) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling TagsApi.getTaggedObjects, must be bigger than or equal to 1.');
        }

        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling TagsApi.getTaggedObjects, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 25) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling TagsApi.getTaggedObjects, must be bigger than or equal to 25.');
        }
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\InlineResponse20060|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function getTags($page = 1, $page_size = 100)
    {
        list($response) = $this->getTagsWithHttpInfo($page, $page_size);
        return $response;
    }
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\InlineResponse20060|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsWithHttpInfo($page = 1, $page_size = 100)
    {
        $request = $this->getTagsRequest($page, $page_size);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\InlineResponse20060' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20060', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20060';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20060',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsync($page = 1, $page_size = 100)
    {
        return $this->getTagsAsyncWithHttpInfo($page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsAsyncWithHttpInfo($page = 1, $page_size = 100)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20060';
        $request = $this->getTagsRequest($page, $page_size);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsRequest($page = 1, $page_size = 100)
    {
        if ($page !== null && $page < 1) {
        ...
        if ($page_size !== null && $page_size > 100) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling TagsApi.getTags, must be smaller than or equal to 100.');
        }
        if ($page_size !== null && $page_size < 25) {
            throw new \InvalidArgumentException('invalid value for "$page_size" when calling TagsApi.getTags, must be bigger than or equal to 25.');
        }
