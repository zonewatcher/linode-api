...
/**
 * LinodeTypesApi Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
...
class LinodeTypesApi
{
     ...
     * Type View
     *
     * @param  string $type_id The ID of the Linode Type to look up. (required)
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeType|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function getLinodeType($type_id)
    {
        list($response) = $this->getLinodeTypeWithHttpInfo($type_id);
        return $response;
    }

    /**
     * Operation getLinodeTypeWithHttpInfo
     *
     * Type View
     *
     * @param  string $type_id The ID of the Linode Type to look up. (required)
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\LinodeType|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLinodeTypeWithHttpInfo($type_id)
    {
        $request = $this->getLinodeTypeRequest($type_id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\LinodeType' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\LinodeType', []),
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\LinodeType';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\LinodeType',
     ...
     */
    public function getLinodeTypeAsync($type_id)
    {
        return $this->getLinodeTypeAsyncWithHttpInfo($type_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getLinodeTypeAsyncWithHttpInfo
     *
     * Type View
     *
     * @param  string $type_id The ID of the Linode Type to look up. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLinodeTypeAsyncWithHttpInfo($type_id)
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\LinodeType';
        $request = $this->getLinodeTypeRequest($type_id);
    ...
    /**
     * Create request for operation 'getLinodeType'
     *
     * @param  string $type_id The ID of the Linode Type to look up. (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getLinodeTypeRequest($type_id)
    {
        // verify the required parameter 'type_id' is set
        if ($type_id === null || (is_array($type_id) && count($type_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $type_id when calling getLinodeType'
            );
        }

        $resourcePath = '/linode/types/{typeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ZoneWatcher\LinodeApiV4\Model\InlineResponse20026|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault
     */
    public function getLinodeTypes()
    {
        list($response) = $this->getLinodeTypesWithHttpInfo();
        return $response;
    }

    /**
     * Operation getLinodeTypesWithHttpInfo
     *
     * Types List
     *
     *
     * @throws \ZoneWatcher\LinodeApiV4\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ZoneWatcher\LinodeApiV4\Model\InlineResponse20026|\ZoneWatcher\LinodeApiV4\Model\InlineResponseDefault, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLinodeTypesWithHttpInfo()
    {
        $request = $this->getLinodeTypesRequest();
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZoneWatcher\LinodeApiV4\Model\InlineResponse20026' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20026', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20026';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20026',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLinodeTypesAsync()
    {
        return $this->getLinodeTypesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getLinodeTypesAsyncWithHttpInfo
     *
     * Types List
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLinodeTypesAsyncWithHttpInfo()
    {
        $returnType = '\ZoneWatcher\LinodeApiV4\Model\InlineResponse20026';
        $request = $this->getLinodeTypesRequest();
    ...
    /**
     * Create request for operation 'getLinodeTypes'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getLinodeTypesRequest()
    {

        $resourcePath = '/linode/types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
