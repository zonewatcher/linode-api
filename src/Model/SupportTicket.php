...
class SupportTicket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'closable' => 'bool',
        'description' => 'string',
        'entity' => '\ZoneWatcher\LinodeApiV4\Model\SupportTicketEntity',
        'gravatar_id' => 'string',
        'opened' => '\DateTime',
        'opened_by' => 'string',
        'status' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['closable'] = $data['closable'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['entity'] = $data['entity'] ?? null;
        $this->container['gravatar_id'] = $data['gravatar_id'] ?? null;
        $this->container['opened'] = $data['opened'] ?? null;
        $this->container['opened_by'] = $data['opened_by'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['description']) && (mb_strlen($this->container['description']) > 65000)) {
        ...
        if (!is_null($this->container['summary']) && (mb_strlen($this->container['summary']) > 64)) {
     ...
     * Sets id
     *
     * @param int|null $id The ID of the Support Ticket.
     *
     * @return self
     */
     ...
     * Sets attachments
     *
     * @param string[]|null $attachments A list of filenames representing attached files associated with this Ticket.
     *
     * @return self
     */
     ...
     * Sets closed
     *
     * @param \DateTime|null $closed The date and time this Ticket was closed.
     *
     * @return self
     */
     ...
     * Sets closable
     *
     * @param bool|null $closable Whether the Support Ticket may be closed.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The full details of the issue or question.
     *
     * @return self
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 65000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicket., must be smaller than or equal to 65000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicket., must be bigger than or equal to 1.');
        }
     ...
     * Gets entity
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\SupportTicketEntity|null
     */
     ...
     * Sets entity
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\SupportTicketEntity|null $entity entity
     *
     * @return self
     */
     ...
     * Sets gravatar_id
     *
     * @param string|null $gravatar_id The Gravatar ID of the User who opened this Ticket.
     *
     * @return self
     */
     ...
     * Sets opened
     *
     * @param \DateTime|null $opened The date and time this Ticket was created.
     *
     * @return self
     */
     ...
     * Sets opened_by
     *
     * @param string|null $opened_by The User who opened this Ticket.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The current status of this Ticket.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param string|null $summary The summary or title for this Ticket.
     *
     * @return self
     */
    public function setSummary($summary)
    {
        if (!is_null($summary) && (mb_strlen($summary) > 64)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling SupportTicket., must be smaller than or equal to 64.');
        }
        if (!is_null($summary) && (mb_strlen($summary) < 1)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling SupportTicket., must be bigger than or equal to 1.');
        }
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated The date and time this Ticket was last updated.
     *
     * @return self
     */
     ...
     * Sets updated_by
     *
     * @param string|null $updated_by The User who last updated this Ticket.
     *
     * @return self
     */
