...
class Device implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['disk_id'] = $data['disk_id'] ?? null;
     ...
     * Sets disk_id
     *
     * @param int|null $disk_id The Disk ID, or `null` if a Volume is assigned to this slot.
     *
     * @return self
     */
     ...
     * Sets volume_id
     *
     * @param int|null $volume_id The Volume ID, or `null` if a Disk is assigned to this slot.
     *
     * @return self
     */
