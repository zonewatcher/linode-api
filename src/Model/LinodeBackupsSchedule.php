...
/**
 * LinodeBackupsSchedule Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 ...
 */
class LinodeBackupsSchedule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Linode_backups_schedule';
    ...
    const DAY_SCHEDULING = 'Scheduling';
    ...
    const WINDOW_SCHEDULING = 'Scheduling';
    const WINDOW_W0 = 'W0';
    const WINDOW_W2 = 'W2';
    const WINDOW_W4 = 'W4';
    const WINDOW_W6 = 'W6';
    const WINDOW_W8 = 'W8';
    const WINDOW_W10 = 'W10';
    const WINDOW_W12 = 'W12';
    const WINDOW_W14 = 'W14';
    const WINDOW_W16 = 'W16';
    const WINDOW_W18 = 'W18';
    const WINDOW_W20 = 'W20';
    const WINDOW_W22 = 'W22';
     ...
     * Sets window
     *
     * @param string|null $window The window in which your backups will be taken, in UTC. A backups window is a two-hour span of time in which the backup may occur.   For example, `W10` indicates that your backups should be taken between 10:00 and 12:00. If you do not choose a backup window, one will be selected for you automatically.   If not set manually, when backups are initially enabled this may come back as `Scheduling` until the `window` is automatically selected.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getWindowAllowableValues();
        if (!is_null($window) && !in_array($window, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'window', must be one of '%s'",
                    $window,
