...
/**
 * NodeBalancer Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancer';
    ...
    protected static $openAPITypes = [
        ...
        'transfer' => '\ZoneWatcher\LinodeApiV4\Model\NodeBalancerTransfer',
        'tags' => 'string[]'
    ];
    ...
    protected static $setters = [
        ...
        'created' => 'setCreated',
        'updated' => 'setUpdated',
        'client_conn_throttle' => 'setClientConnThrottle',
    ...
    protected static $getters = [
        ...
        'created' => 'getCreated',
        'updated' => 'getUpdated',
        'client_conn_throttle' => 'getClientConnThrottle',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['client_conn_throttle'] = $data['client_conn_throttle'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label']) && !preg_match("/[a-zA-Z0-9-_]{3,32}/", $this->container['label'])) {
            $invalidProperties[] = "invalid value for 'label', must be conform to the pattern /[a-zA-Z0-9-_]{3,32}/.";
        }

        if (!is_null($this->container['client_conn_throttle']) && ($this->container['client_conn_throttle'] > 20)) {
            $invalidProperties[] = "invalid value for 'client_conn_throttle', must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['client_conn_throttle']) && ($this->container['client_conn_throttle'] < 0)) {
            $invalidProperties[] = "invalid value for 'client_conn_throttle', must be bigger than or equal to 0.";
        }
     ...
     * Sets id
     *
     * @param int|null $id This NodeBalancer's unique ID.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label This NodeBalancer's label. These must be unique on your Account.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling NodeBalancer., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling NodeBalancer., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/[a-zA-Z0-9-_]{3,32}/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling NodeBalancer., must conform to the pattern /[a-zA-Z0-9-_]{3,32}/.");
        }
     ...
     * Sets region
     *
     * @param string|null $region The Region where this NodeBalancer is located. NodeBalancers only support backends in the same Region.
     *
     * @return self
     */
     ...
     * Sets hostname
     *
     * @param string|null $hostname This NodeBalancer's hostname, ending with _.nodebalancer.linode.com_
     *
     * @return self
     */
     ...
     * Sets ipv4
     *
     * @param string|null $ipv4 This NodeBalancer's public IPv4 address.
     *
     * @return self
     */
     ...
     * Sets ipv6
     *
     * @param string|null $ipv6 This NodeBalancer's public IPv6 address.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this NodeBalancer was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this NodeBalancer was last updated.
     *
     * @return self
     */
    ...
    /**
     * Gets client_conn_throttle
     *
     * @return int|null
     */
    public function getClientConnThrottle()
    {
        return $this->container['client_conn_throttle'];
    }

    /**
     * Sets client_conn_throttle
     *
     * @param int|null $client_conn_throttle Throttle connections per second.  Set to 0 (zero) to disable throttling.
     *
     * @return self
     */
    public function setClientConnThrottle($client_conn_throttle)
    {

        if (!is_null($client_conn_throttle) && ($client_conn_throttle > 20)) {
            throw new \InvalidArgumentException('invalid value for $client_conn_throttle when calling NodeBalancer., must be smaller than or equal to 20.');
        }
        if (!is_null($client_conn_throttle) && ($client_conn_throttle < 0)) {
            throw new \InvalidArgumentException('invalid value for $client_conn_throttle when calling NodeBalancer., must be bigger than or equal to 0.');
        }

        $this->container['client_conn_throttle'] = $client_conn_throttle;
     ...
     * Gets transfer
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\NodeBalancerTransfer|null
     */
     ...
     * Sets transfer
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\NodeBalancerTransfer|null $transfer transfer
     *
     * @return self
     */
