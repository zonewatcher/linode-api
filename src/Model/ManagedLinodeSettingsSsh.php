...
/**
 * ManagedLinodeSettingsSsh Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedLinodeSettingsSsh implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedLinodeSettings_ssh';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['user']) && (mb_strlen($this->container['user']) > 32)) {
            $invalidProperties[] = "invalid value for 'user', the character length must be smaller than or equal to 32.";
        }

        if (!is_null($this->container['user']) && (mb_strlen($this->container['user']) < 0)) {
            $invalidProperties[] = "invalid value for 'user', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets access
     *
     * @param bool|null $access If true, Linode special forces may access this Linode over ssh to respond to Issues.
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param string|null $user The user Linode's special forces should use when accessing this Linode to respond to an issue.
     *
     * @return self
     */
    public function setUser($user)
    {
        if (!is_null($user) && (mb_strlen($user) > 32)) {
            throw new \InvalidArgumentException('invalid length for $user when calling ManagedLinodeSettingsSsh., must be smaller than or equal to 32.');
        }
        if (!is_null($user) && (mb_strlen($user) < 0)) {
            throw new \InvalidArgumentException('invalid length for $user when calling ManagedLinodeSettingsSsh., must be bigger than or equal to 0.');
        }
     ...
     * Sets ip
     *
     * @param string|null $ip The IP Linode special forces should use to access this Linode when responding to an Issue.
     *
     * @return self
     */
     ...
     * Sets port
     *
     * @param int|null $port The port Linode special forces should use to access this Linode over ssh to respond to an Issue.
     *
     * @return self
     */
    public function setPort($port)
    {
        ...
        if (!is_null($port) && ($port > 65535)) {
            throw new \InvalidArgumentException('invalid value for $port when calling ManagedLinodeSettingsSsh., must be smaller than or equal to 65535.');
        }
        if (!is_null($port) && ($port < 1)) {
            throw new \InvalidArgumentException('invalid value for $port when calling ManagedLinodeSettingsSsh., must be bigger than or equal to 1.');
        }
