...
class PersonalAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id This token's unique ID, which can be used to revoke it.
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string|null $scopes The scopes this token was created with. These define what parts of the Account the token can be used to access. Many command-line tools, such as the <a target=\"_top\" href=\"https://github.com/linode/linode-cli\">Linode CLI</a>, require tokens with access to `*`. Tokens with more restrictive scopes are generally more secure.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date and time this token was created.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label This token's label.  This is for display purposes only, but can be used to more easily track what you're using each token for.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 100)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PersonalAccessToken., must be smaller than or equal to 100.');
        }
        if (!is_null($label) && (mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PersonalAccessToken., must be bigger than or equal to 1.');
        }
     ...
     * Sets token
     *
     * @param string|null $token The token used to access the API.  When the token is created, the full token is returned here.  Otherwise, only the first 16 characters are returned.
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry When this token will expire.  Personal Access Tokens cannot be renewed, so after this time the token will be completely unusable and a new token will need to be generated.  Tokens may be created with \"null\" as their expiry and will never expire unless revoked.
     *
     * @return self
     */
