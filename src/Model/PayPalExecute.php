...
/**
 * PayPalExecute Class Doc Comment
 *
 * @category Class
 ...
 */
class PayPalExecute implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayPalExecute';
     ...
     * Sets payment_id
     *
     * @param string $payment_id The PaymentID returned from [POST /account/payments/paypal](/docs/api/account/#paypal-payment-stage) that has been approved with PayPal.
     *
     * @return self
     */
