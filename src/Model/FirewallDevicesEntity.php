...
/**
 * FirewallDevicesEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class FirewallDevicesEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallDevices_entity';
     ...
     * Sets id
     *
     * @param int|null $id The entity's ID
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The entity's type.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The entity's label.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL you can use to access this entity.
     *
     * @return self
     */
