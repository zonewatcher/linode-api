...
/**
 * SupportTicketReply Class Doc Comment
 *
 * @category Class
 ...
 */
class SupportTicketReply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportTicketReply';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['from_linode'] = $data['from_linode'] ?? null;
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date and time this Ticket reply was created.
     *
     * @return self
     */
     ...
     * Sets created_by
     *
     * @param string|null $created_by The User who submitted this reply.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description The body of this Support Ticket reply.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getFromLinode()
    {
        return $this->container['from_linode'];
    }

    /**
     * Sets from_linode
     *
     * @param bool|null $from_linode If set to true, this reply came from a Linode employee.
     *
     * @return self
     */
    public function setFromLinode($from_linode)
    {
        $this->container['from_linode'] = $from_linode;
     ...
     * Sets gravatar_id
     *
     * @param string|null $gravatar_id The Gravatar ID of the User who created this reply.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this Support Ticket reply.
     *
     * @return self
     */
