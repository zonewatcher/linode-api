...
class Volume implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'size' => 'int',
        'region' => '\ZoneWatcher\LinodeApiV4\Model\Id',
        'linode_id' => 'int',
        'linode_label' => 'string',
        'created' => '\DateTime',
        'updated' => '\DateTime',
    ...
    protected static $setters = [
        'id' => 'setId',
        'label' => 'setLabel',
        'filesystem_path' => 'setFilesystemPath',
        'status' => 'setStatus',
        'size' => 'setSize',
        'region' => 'setRegion',
        'linode_id' => 'setLinodeId',
        'linode_label' => 'setLinodeLabel',
        'created' => 'setCreated',
        'updated' => 'setUpdated',
        'tags' => 'setTags',
    ...
    protected static $getters = [
        'id' => 'getId',
        'label' => 'getLabel',
        'filesystem_path' => 'getFilesystemPath',
        'status' => 'getStatus',
        'size' => 'getSize',
        'region' => 'getRegion',
        'linode_id' => 'getLinodeId',
        'linode_label' => 'getLinodeLabel',
        'created' => 'getCreated',
        'updated' => 'getUpdated',
        'tags' => 'getTags',
    ...
    const STATUS_CONTACT_SUPPORT = 'contact_support';
    const HARDWARE_TYPE_HDD = 'hdd';
    const HARDWARE_TYPE_NVME = 'nvme';
     ...
     * @return string[]
     */
    public function getHardwareTypeAllowableValues()
    {
        return [
            self::HARDWARE_TYPE_HDD,
            self::HARDWARE_TYPE_NVME,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['filesystem_path'] = $data['filesystem_path'] ?? null;
        $this->container['status'] = $data['status'] ?? null;
        $this->container['size'] = $data['size'] ?? null;
        $this->container['region'] = $data['region'] ?? null;
        $this->container['linode_id'] = $data['linode_id'] ?? null;
        $this->container['linode_label'] = $data['linode_label'] ?? null;
        $this->container['created'] = $data['created'] ?? null;
        $this->container['updated'] = $data['updated'] ?? null;
        $this->container['tags'] = $data['tags'] ?? null;
        $this->container['hardware_type'] = $data['hardware_type'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['size']) && ($this->container['size'] > 10240)) {
            $invalidProperties[] = "invalid value for 'size', must be smaller than or equal to 10240.";
        }

        $allowedValues = $this->getHardwareTypeAllowableValues();
        if (!is_null($this->container['hardware_type']) && !in_array($this->container['hardware_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'hardware_type', must be one of '%s'",
                $this->container['hardware_type'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this Volume.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The Volume's label is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Volume., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Volume., must be bigger than or equal to 1.');
        }
        if (!is_null($label) && (!preg_match("/^[a-zA-Z]((?!--|__)[a-zA-Z0-9-_])+$/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling Volume., must conform to the pattern /^[a-zA-Z]((?!--|__)[a-zA-Z0-9-_])+$/.");
        }
    ...
    /**
     * Gets filesystem_path
     *
     * @return string|null
     */
    public function getFilesystemPath()
    {
        return $this->container['filesystem_path'];
    }

    /**
     * Sets filesystem_path
     *
     * @param string|null $filesystem_path The full filesystem path for the Volume based on the Volume's label. Path is /dev/disk/by-id/scsi-0Linode_Volume_ + Volume label.
     *
     * @return self
     */
    public function setFilesystemPath($filesystem_path)
    {
        $this->container['filesystem_path'] = $filesystem_path;
     ...
     * Sets size
     *
     * @param int|null $size The Volume's size, in GiB.
     *
     * @return self
     */
    public function setSize($size)
    {
        ...
        if (!is_null($size) && ($size > 10240)) {
            throw new \InvalidArgumentException('invalid value for $size when calling Volume., must be smaller than or equal to 10240.');
        }
     ...
     * Gets region
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Id|null
     */
     ...
     * Sets region
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Id|null $region region
     *
     * @return self
     */
    ...
    {
        return $this->container['linode_id'];
    }

    /**
     * Sets linode_id
     *
     * @param int|null $linode_id If a Volume is attached to a specific Linode, the ID of that Linode will be displayed here.
     *
     * @return self
     */
    public function setLinodeId($linode_id)
    {
        $this->container['linode_id'] = $linode_id;
     ...
     * @return string|null
     */
    public function getLinodeLabel()
    {
        return $this->container['linode_label'];
    }

    /**
     * Sets linode_label
     *
     * @param string|null $linode_label If a Volume is attached to a specific Linode, the label of that Linode will be displayed here.
     *
     * @return self
     */
    public function setLinodeLabel($linode_label)
    {
        $this->container['linode_label'] = $linode_label;
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Volume was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Volume was last updated.
     *
     * @return self
     */
     ...
     * Sets hardware_type
     *
     * @param string|null $hardware_type The storage type of this Volume.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getHardwareTypeAllowableValues();
        if (!is_null($hardware_type) && !in_array($hardware_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'hardware_type', must be one of '%s'",
                    $hardware_type,
