...
/**
 * LongviewClient Class Doc Comment
 *
 * @category Class
 ...
 */
class LongviewClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongviewClient';
    ...
    protected static $openAPITypes = [
        ...
        'api_key' => 'string',
        'install_code' => 'string',
        'apps' => '\ZoneWatcher\LinodeApiV4\Model\LongviewClientApps',
        'created' => '\DateTime',
        'updated' => '\DateTime'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['install_code'] = $data['install_code'] ?? null;
     ...
     * Sets id
     *
     * @param int|null $id This Client's unique ID.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label This Client's unique label. This is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling LongviewClient., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling LongviewClient., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/[a-zA-Z0-9-_]{3,32}/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling LongviewClient., must conform to the pattern /[a-zA-Z0-9-_]{3,32}/.");
        }
     ...
     * Sets api_key
     *
     * @param string|null $api_key The API key for this Client, used when configuring the Longview Client application on your Linode.  Returns as `[REDACTED]` if you do not have read-write access to this client.
     *
     * @return self
     */
    ...
    {
        return $this->container['install_code'];
    }

    /**
     * Sets install_code
     *
     * @param string|null $install_code The install code for this Client, used when configuring the Longview Client application on your Linode.  Returns as `[REDACTED]` if you do not have read-write access to this client.
     *
     * @return self
     */
    public function setInstallCode($install_code)
    {
        $this->container['install_code'] = $install_code;
     ...
     * Gets apps
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LongviewClientApps|null
     */
     ...
     * Sets apps
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LongviewClientApps|null $apps apps
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Longview Client was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Longview Client was last updated.
     *
     * @return self
     */
