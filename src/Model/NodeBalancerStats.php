...
/**
 * NodeBalancerStats Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancerStats';
    ...
    protected static $openAPITypes = [
        'data' => '\ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsData',
        'title' => 'string'
    ];
     ...
     * Gets data
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsData|null
     */
     ...
     * Sets data
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsData|null $data data
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The title for the statistics generated in this response.
     *
     * @return self
     */
