...
/**
 * LinodeStatsNetv6 Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeStatsNetv6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeStats_netv6';
    ...
    protected static $setters = [
        'in' => 'setIn',
        'out' => 'setOut',
        'private_in' => 'setPrivateIn',
        'private_out' => 'setPrivateOut'
    ];
    ...
    protected static $getters = [
        'in' => 'getIn',
        'out' => 'getOut',
        'private_in' => 'getPrivateIn',
        'private_out' => 'getPrivateOut'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['private_in'] = $data['private_in'] ?? null;
        $this->container['private_out'] = $data['private_out'] ?? null;
    }
     ...
     * Sets in
     *
     * @param float[][]|null $in Input stats for IPv6, measured in bits/s (bits/second).
     *
     * @return self
     */
     ...
     * Sets out
     *
     * @param float[][]|null $out Output stats for IPv6, measured in bits/s (bits/second).
     *
     * @return self
     */
     ...
     * @return float[][]|null
     */
    public function getPrivateIn()
    {
        return $this->container['private_in'];
    }

    /**
     * Sets private_in
     *
     * @param float[][]|null $private_in Private IPv6 input statistics, measured in bits/s (bits/second).
     *
     * @return self
     */
    public function setPrivateIn($private_in)
    {
        $this->container['private_in'] = $private_in;
     ...
     * @return float[][]|null
     */
    public function getPrivateOut()
    {
        return $this->container['private_out'];
    }

    /**
     * Sets private_out
     *
     * @param float[][]|null $private_out Private IPv6 output statistics, measured in bits/s (bits/second).
     *
     * @return self
     */
    public function setPrivateOut($private_out)
    {
        $this->container['private_out'] = $private_out;
