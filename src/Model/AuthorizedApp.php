...
/**
 * AuthorizedApp Class Doc Comment
 *
 * @category Class
 ...
 */
class AuthorizedApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthorizedApp';
     ...
     * Sets id
     *
     * @param int|null $id This authorization's ID, used for revoking access.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The name of the application you've authorized.
     *
     * @return self
     */
     ...
     * Sets thumbnail_url
     *
     * @param string|null $thumbnail_url The URL at which this app's thumbnail may be accessed.
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string|null $scopes The OAuth scopes this app was authorized with.  This defines what parts of your Account the app is allowed to access.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this app was authorized.
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry When the app's access to your account expires. If `null`, the app's access must be revoked manually.
     *
     * @return self
     */
     ...
     * Sets website
     *
     * @param string|null $website The website where you can get more information about this app.
     *
     * @return self
     */
