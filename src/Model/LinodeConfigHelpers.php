...
/**
 * LinodeConfigHelpers Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeConfigHelpers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeConfig_helpers';
    ...
    protected static $setters = [
        'updatedb_disabled' => 'setUpdatedbDisabled',
        'distro' => 'setDistro',
        'modules_dep' => 'setModulesDep',
        'network' => 'setNetwork',
        'devtmpfs_automount' => 'setDevtmpfsAutomount'
    ];
    ...
    protected static $getters = [
        'updatedb_disabled' => 'getUpdatedbDisabled',
        'distro' => 'getDistro',
        'modules_dep' => 'getModulesDep',
        'network' => 'getNetwork',
        'devtmpfs_automount' => 'getDevtmpfsAutomount'
    ];
    ...
    {
        $this->container['updatedb_disabled'] = $data['updatedb_disabled'] ?? null;
        $this->container['distro'] = $data['distro'] ?? null;
        $this->container['modules_dep'] = $data['modules_dep'] ?? null;
        $this->container['network'] = $data['network'] ?? null;
        $this->container['devtmpfs_automount'] = $data['devtmpfs_automount'] ?? null;
    }
    ...
    /**
     * Gets updatedb_disabled
     *
     * @return bool|null
     */
    public function getUpdatedbDisabled()
    {
        return $this->container['updatedb_disabled'];
    }

    /**
     * Sets updatedb_disabled
     *
     * @param bool|null $updatedb_disabled Disables updatedb cron job to avoid disk thrashing.
     *
     * @return self
     */
    public function setUpdatedbDisabled($updatedb_disabled)
    {
        $this->container['updatedb_disabled'] = $updatedb_disabled;
     ...
     * Sets distro
     *
     * @param bool|null $distro Helps maintain correct inittab/upstart console device.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getModulesDep()
    {
        return $this->container['modules_dep'];
    }

    /**
     * Sets modules_dep
     *
     * @param bool|null $modules_dep Creates a modules dependency file for the Kernel you run.
     *
     * @return self
     */
    public function setModulesDep($modules_dep)
    {
        $this->container['modules_dep'] = $modules_dep;
     ...
     * Sets network
     *
     * @param bool|null $network Automatically configures static networking.
     *
     * @return self
     */
    ...
    /**
     * Gets devtmpfs_automount
     *
     * @return bool|null
     */
    public function getDevtmpfsAutomount()
    {
        return $this->container['devtmpfs_automount'];
    }

    /**
     * Sets devtmpfs_automount
     *
     * @param bool|null $devtmpfs_automount Populates the /dev directory early during boot without udev.  Defaults to false.
     *
     * @return self
     */
    public function setDevtmpfsAutomount($devtmpfs_automount)
    {
        $this->container['devtmpfs_automount'] = $devtmpfs_automount;
