...
class OAuthClient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['public'] = $data['public'] ?? false;
    }
     ...
     * Sets id
     *
     * @param string|null $id The OAuth Client ID.  This is used to identify the client, and is a publicly-known value (it is not a secret).
     *
     * @return self
     */
     ...
     * Sets redirect_uri
     *
     * @param string|null $redirect_uri The location a successful log in from <a target=\"_top\" href=\"https://login.linode.com\">https://login.linode.com</a> should be redirected to for this client.  The receiver of this redirect should be ready to accept an OAuth exchange code and finish the OAuth exchange.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The name of this application.  This will be presented to users when they are asked to grant it access to their Account.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 512)) {
            throw new \InvalidArgumentException('invalid length for $label when calling OAuthClient., must be smaller than or equal to 512.');
        }
        if (!is_null($label) && (mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling OAuthClient., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string|null $status The status of this application.  `active` by default.
     *
     * @return self
     */
     ...
     * Sets secret
     *
     * @param string|null $secret The OAuth Client secret, used in the OAuth exchange.  This is returned as `<REDACTED>` except when an OAuth Client is created or its secret is reset.  This is a secret, and should not be shared or disclosed publicly.
     *
     * @return self
     */
     ...
     * Sets thumbnail_url
     *
     * @param string|null $thumbnail_url The URL where this client's thumbnail may be viewed, or `null` if this client does not have a thumbnail set.
     *
     * @return self
     */
     ...
     * Sets public
     *
     * @param bool|null $public If this is a public or private OAuth Client.  Public clients have a slightly different authentication workflow than private clients.  See the <a target=\"_top\" href=\"https://oauth.net/2/\">OAuth spec</a> for more details.
     *
     * @return self
     */
