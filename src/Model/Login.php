...
class Login implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this login object.
     *
     * @return self
     */
     ...
     * Sets datetime
     *
     * @param \DateTime|null $datetime When the login was initiated.
     *
     * @return self
     */
     ...
     * Sets ip
     *
     * @param string|null $ip The remote IP address that requested the login.
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username The username of the User that was logged into.
     *
     * @return self
     */
     ...
     * Sets restricted
     *
     * @param bool|null $restricted True if the User that was logged into was a restricted User, false otherwise.
     *
     * @return self
     */
