...
/**
 * LinodeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeRequest';
    ...
    protected static $openAPITypes = [
        'image' => '\ZoneWatcher\LinodeApiV4\Model\Image',
        'root_pass' => '\ZoneWatcher\LinodeApiV4\Model\RootPass',
        'authorized_keys' => '\ZoneWatcher\LinodeApiV4\Model\AuthorizedKeys',
        'authorized_users' => '\ZoneWatcher\LinodeApiV4\Model\AuthorizedUsers',
        'stackscript_id' => '\ZoneWatcher\LinodeApiV4\Model\StackscriptId',
        'stackscript_data' => '\ZoneWatcher\LinodeApiV4\Model\StackscriptData',
        'booted' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['booted'] = $data['booted'] ?? true;
    }
     ...
     * Gets image
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Image|null
     */
     ...
     * Sets image
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Image|null $image image
     *
     * @return self
     */
     ...
     * Gets root_pass
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\RootPass|null
     */
     ...
     * Sets root_pass
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\RootPass|null $root_pass root_pass
     *
     * @return self
     */
     ...
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\AuthorizedKeys|null
     */
     ...
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\AuthorizedKeys|null $authorized_keys authorized_keys
     *
     * @return self
     */
     ...
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\AuthorizedUsers|null
     */
     ...
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\AuthorizedUsers|null $authorized_users authorized_users
     *
     * @return self
     */
     ...
     * Gets stackscript_id
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\StackscriptId|null
     */
     ...
     * Sets stackscript_id
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StackscriptId|null $stackscript_id stackscript_id
     *
     * @return self
     */
     ...
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\StackscriptData|null
     */
     ...
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StackscriptData|null $stackscript_data stackscript_data
     *
     * @return self
     */
     ...
     * Sets booted
     *
     * @param bool|null $booted This field defaults to `true` if the Linode is created with an Image or from a Backup. If it is deployed from an Image or a Backup and you wish it to remain `offline` after deployment, set this to `false`.
     *
     * @return self
     */
    public function setBooted($booted)
    {
        $this->container['booted'] = $booted;
