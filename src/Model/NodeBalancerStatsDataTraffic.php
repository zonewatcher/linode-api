...
/**
 * NodeBalancerStatsDataTraffic Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerStatsDataTraffic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancerStats_data_traffic';
     ...
     * Sets in
     *
     * @param float[]|null $in An array of key/value pairs representing unix timestamp and reading for inbound traffic.
     *
     * @return self
     */
     ...
     * Sets out
     *
     * @param float[]|null $out An array of key/value pairs representing unix timestamp and reading for outbound traffic.
     *
     * @return self
     */
