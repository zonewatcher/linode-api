...
/**
 * SupportTicketRequest Class Doc Comment
 *
 * @category Class
 * @description An object representing a created Support Ticket - a question or issue and request for help from the Linode support team. Only one of the ID attributes (&#x60;linode_id&#x60;, &#x60;domain_id&#x60;, etc.) can be set on a single Support Ticket.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class SupportTicketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportTicketRequest';
    ...
    protected static $setters = [
        ...
        'longviewclient_id' => 'setLongviewclientId',
        'nodebalancer_id' => 'setNodebalancerId',
        'summary' => 'setSummary',
        'managed_issue' => 'setManagedIssue',
    ...
    protected static $getters = [
        ...
        'longviewclient_id' => 'getLongviewclientId',
        'nodebalancer_id' => 'getNodebalancerId',
        'summary' => 'getSummary',
        'managed_issue' => 'getManagedIssue',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['longviewclient_id'] = $data['longviewclient_id'] ?? null;
        $this->container['nodebalancer_id'] = $data['nodebalancer_id'] ?? null;
        $this->container['summary'] = $data['summary'] ?? null;
        $this->container['managed_issue'] = $data['managed_issue'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['description']) > 65000)) {
            $invalidProperties[] = "invalid value for 'description', the character length must be smaller than or equal to 65000.";
        }
        ...
        if ((mb_strlen($this->container['summary']) > 64)) {
            $invalidProperties[] = "invalid value for 'summary', the character length must be smaller than or equal to 64.";
        }
     ...
     * Sets description
     *
     * @param string $description The full details of the issue or question.
     *
     * @return self
     */
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 65000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicketRequest., must be smaller than or equal to 65000.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling SupportTicketRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets domain_id
     *
     * @param int|null $domain_id The ID of the Domain this ticket is regarding, if relevant.
     *
     * @return self
     */
     ...
     * Sets linode_id
     *
     * @param int|null $linode_id The ID of the Linode this ticket is regarding, if relevant.
     *
     * @return self
     */
    ...
    /**
     * Gets longviewclient_id
     *
     * @return int|null
     */
    public function getLongviewclientId()
    {
        return $this->container['longviewclient_id'];
    }

    /**
     * Sets longviewclient_id
     *
     * @param int|null $longviewclient_id The ID of the Longview client this ticket is regarding, if relevant.
     *
     * @return self
     */
    public function setLongviewclientId($longviewclient_id)
    {
        $this->container['longviewclient_id'] = $longviewclient_id;
     ...
     *
     * @param int|null $nodebalancer_id The ID of the NodeBalancer this ticket is regarding, if relevant.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param string $summary The summary or title for this SupportTicket.
     *
     * @return self
     */
    public function setSummary($summary)
    {
        if ((mb_strlen($summary) > 64)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling SupportTicketRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($summary) < 1)) {
            throw new \InvalidArgumentException('invalid length for $summary when calling SupportTicketRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets volume_id
     *
     * @param int|null $volume_id The ID of the Volume this ticket is regarding, if relevant.
     *
     * @return self
     */
     ...
     * Sets vlan
     *
     * @param string|null $vlan The label of the VLAN this ticket is regarding, if relevant. To view your VLANs, use the VLANs List ([GET /networking/vlans](/docs/api/networking/#vlans-list)) endpoint.  Requires a specified `region` to identify the VLAN.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The [Region](/docs/api/regions/) ID for the associated VLAN this ticket is regarding.  Only allowed when submitting a VLAN ticket.
     *
     * @return self
     */
