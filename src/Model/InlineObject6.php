...
class InlineObject6 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets label
     *
     * @param string $label The label for the new snapshot.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject6., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject6., must be bigger than or equal to 1.');
        }
