...
/**
 * LongviewPlan Class Doc Comment
 *
 * @category Class
 ...
 */
class LongviewPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongviewPlan';
    ...
    const LONGVIEW_SUBSCRIPTION__3 = 'longview-3';
    const LONGVIEW_SUBSCRIPTION__10 = 'longview-10';
    const LONGVIEW_SUBSCRIPTION__40 = 'longview-40';
    const LONGVIEW_SUBSCRIPTION__100 = 'longview-100';
     ...
     * @return string[]
     */
    public function getLongviewSubscriptionAllowableValues()
    {
        return [
            self::LONGVIEW_SUBSCRIPTION__3,
            self::LONGVIEW_SUBSCRIPTION__10,
            self::LONGVIEW_SUBSCRIPTION__40,
            self::LONGVIEW_SUBSCRIPTION__100,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLongviewSubscriptionAllowableValues();
        if (!is_null($this->container['longview_subscription']) && !in_array($this->container['longview_subscription'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'longview_subscription', must be one of '%s'",
                $this->container['longview_subscription'],
     ...
     *
     * @param string|null $longview_subscription The subscription ID for a particular Longview plan. A value of `null` corresponds to Longview Free.  You can send a request to the [List Longview Subscriptions](/docs/api/longview/#longview-subscriptions-list) endpoint to receive the details of each plan.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getLongviewSubscriptionAllowableValues();
        if (!is_null($longview_subscription) && !in_array($longview_subscription, $allowedValues, true)) {
