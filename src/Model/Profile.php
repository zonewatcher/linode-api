...
class Profile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'referrals' => '\ZoneWatcher\LinodeApiV4\Model\ProfileReferrals',
    ...
    protected static $setters = [
        ...
        'ip_whitelist_enabled' => 'setIpWhitelistEnabled',
        'lish_auth_method' => 'setLishAuthMethod',
        'authorized_keys' => 'setAuthorizedKeys',
    ...
    protected static $getters = [
        ...
        'ip_whitelist_enabled' => 'getIpWhitelistEnabled',
        'lish_auth_method' => 'getLishAuthMethod',
        'authorized_keys' => 'getAuthorizedKeys',
    ...
    const LISH_AUTH_METHOD_PASSWORD_KEYS = 'password_keys';
    const LISH_AUTH_METHOD_KEYS_ONLY = 'keys_only';
    const LISH_AUTH_METHOD_DISABLED = 'disabled';
    const AUTHENTICATION_TYPE_PASSWORD = 'password';
    const AUTHENTICATION_TYPE_GITHUB = 'github';
     ...
     * @return string[]
     */
    public function getLishAuthMethodAllowableValues()
    {
        return [
            self::LISH_AUTH_METHOD_PASSWORD_KEYS,
            self::LISH_AUTH_METHOD_KEYS_ONLY,
            self::LISH_AUTH_METHOD_DISABLED,
        ];
    }
    ...
    {
        return [
            self::AUTHENTICATION_TYPE_PASSWORD,
            self::AUTHENTICATION_TYPE_GITHUB,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['referrals'] = $data['referrals'] ?? null;
        $this->container['ip_whitelist_enabled'] = $data['ip_whitelist_enabled'] ?? null;
        $this->container['lish_auth_method'] = $data['lish_auth_method'] ?? null;
        $this->container['authorized_keys'] = $data['authorized_keys'] ?? null;
        $this->container['two_factor_auth'] = $data['two_factor_auth'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLishAuthMethodAllowableValues();
        if (!is_null($this->container['lish_auth_method']) && !in_array($this->container['lish_auth_method'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'lish_auth_method', must be one of '%s'",
                $this->container['lish_auth_method'],
     ...
     * Sets uid
     *
     * @param int|null $uid Your unique ID in our system. This value will never change, and can safely be used to identify your User.
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username Your username, used for logging in to our system.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email Your email address.  This address will be used for communication with Linode as necessary.
     *
     * @return self
     */
     ...
     * Sets timezone
     *
     * @param string|null $timezone The timezone you prefer to see times in. This is not used by the API directly. It is provided for the benefit of clients such as the Linode Cloud Manager and other clients built on the API. All times returned by the API are in UTC.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $email_notifications If true, you will receive email notifications about account activity.  If false, you may still receive business-critical communications through email.
     *
     * @return self
     */
     ...
     * Gets referrals
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\ProfileReferrals|null
     */
     ...
     * Sets referrals
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\ProfileReferrals|null $referrals referrals
     *
     * @return self
     */
    ...
    /**
     * Gets ip_whitelist_enabled
     *
     * @return bool|null
     * @deprecated
     */
    public function getIpWhitelistEnabled()
    {
        return $this->container['ip_whitelist_enabled'];
    }

    /**
     * Sets ip_whitelist_enabled
     *
     * @param bool|null $ip_whitelist_enabled If true, logins for your User will only be allowed from whitelisted IPs. This setting is currently deprecated, and cannot be enabled.  If you disable this setting, you will not be able to re-enable it.
     *
     * @return self
     * @deprecated
     */
    public function setIpWhitelistEnabled($ip_whitelist_enabled)
    {
        $this->container['ip_whitelist_enabled'] = $ip_whitelist_enabled;

        return $this;
    }

    /**
     * Gets lish_auth_method
     *
     * @return string|null
     */
    public function getLishAuthMethod()
    {
        return $this->container['lish_auth_method'];
    }

    /**
     * Sets lish_auth_method
     *
     * @param string|null $lish_auth_method The authentication methods that are allowed when connecting to [the Linode Shell (Lish)](/docs/platform/manager/using-the-linode-shell-lish/). * `keys_only` is the most secure if you intend to use Lish. * `disabled` is recommended if you do not intend to use Lish at all. * If this account's Cloud Manager authentication type is set to a Third-Party Authentication method, `password_keys` cannot be used as your Lish authentication method. To view this account's Cloud Manager `authentication_type` field, send a request to the [View Profile](/docs/api/profile/#profile-view) endpoint.
     *
     * @return self
     */
    public function setLishAuthMethod($lish_auth_method)
    {
        $allowedValues = $this->getLishAuthMethodAllowableValues();
        if (!is_null($lish_auth_method) && !in_array($lish_auth_method, $allowedValues, true)) {
        ...
        $this->container['lish_auth_method'] = $lish_auth_method;

        return $this;
    }

    /**
     * Gets authorized_keys
     *
     * @return string[]|null
     */
    public function getAuthorizedKeys()
    {
        return $this->container['authorized_keys'];
    }

    /**
     * Sets authorized_keys
     *
     * @param string[]|null $authorized_keys The list of SSH Keys authorized to use Lish for your User. This value is ignored if `lish_auth_method` is \"disabled.\"
     *
     * @return self
     */
    public function setAuthorizedKeys($authorized_keys)
    {
        $this->container['authorized_keys'] = $authorized_keys;
     ...
     *
     * @param bool|null $two_factor_auth If true, logins from untrusted computers will require Two Factor Authentication.  See [/profile/tfa-enable](/docs/api/profile/#two-factor-secret-create) to enable Two Factor Authentication.
     *
     * @return self
     */
     ...
     * Sets restricted
     *
     * @param bool|null $restricted If true, your User has restrictions on what can be accessed on your Account. To get details on what entities/actions you can access/perform, see [/profile/grants](/docs/api/profile/#grants-list).
     *
     * @return self
     */
