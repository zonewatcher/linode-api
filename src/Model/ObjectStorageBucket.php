 ...
 */
class ObjectStorageBucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageBucket';
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this bucket was created.
     *
     * @return self
     */
     ...
     * Sets cluster
     *
     * @param string|null $cluster The ID of the Object Storage Cluster this bucket is in.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The name of this bucket.
     *
     * @return self
     */
     ...
     * Sets hostname
     *
     * @param string|null $hostname The hostname where this bucket can be accessed. This hostname can be accessed through a browser if the bucket is made public.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The size of the bucket in bytes.
     *
     * @return self
     */
     ...
     * Sets objects
     *
     * @param int|null $objects The number of objects stored in this bucket.
     *
     * @return self
     */
