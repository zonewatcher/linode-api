...
/**
 * ManagedIssueEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedIssueEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedIssue_entity';
     ...
     * Sets id
     *
     * @param int|null $id This ticket's ID
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of entity this is. In this case, it is always a Ticket.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The summary for this Ticket.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The relative URL where you can access this Ticket.
     *
     * @return self
     */
