...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['survey_link'] = $data['survey_link'] ?? null;
    }
    ...
    {
        return $this->container['survey_link'];
    }

    /**
     * Sets survey_link
     *
     * @param string|null $survey_link A link to Linode's exit survey.
     *
     * @return self
     */
    public function setSurveyLink($survey_link)
    {
        $this->container['survey_link'] = $survey_link;
