...
/**
 * NodeBalancerConfigNodesStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerConfigNodesStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancerConfig_nodes_status';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['down'] = $data['down'] ?? null;
    }
     ...
     * Sets up
     *
     * @param int|null $up The number of backends considered to be \"UP\" and healthy, and that are serving requests.
     *
     * @return self
     */
     ...
     * Sets down
     *
     * @param int|null $down The number of backends considered to be \"DOWN\" and unhealthy.  These are not in rotation, and not serving requests.
     *
     * @return self
     */
