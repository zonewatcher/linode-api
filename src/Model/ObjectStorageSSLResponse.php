...
/**
 * ObjectStorageSSLResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectStorageSSLResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageSSLResponse';
     ...
     * Sets ssl
     *
     * @param bool|null $ssl A boolean indicating if this Bucket has a corresponding TLS/SSL certificate that was uploaded by an Account user.
     *
     * @return self
     */
