...
/**
 * NodeBalancerStatsData Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerStatsData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancerStats_data';
    ...
    protected static $openAPITypes = [
        'connections' => 'float[]',
        'traffic' => '\ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsDataTraffic'
    ];
     ...
     * Sets connections
     *
     * @param float[]|null $connections An array of key/value pairs representing unix timestamp and reading for connections to this NodeBalancer.
     *
     * @return self
     */
     ...
     * Gets traffic
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsDataTraffic|null
     */
     ...
     * Sets traffic
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\NodeBalancerStatsDataTraffic|null $traffic traffic
     *
     * @return self
     */
