...
/**
 * MaintenanceEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class MaintenanceEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Maintenance_entity';
     ...
     * Sets label
     *
     * @param string|null $label The label of the entity being affected by maintenance.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param float|null $id The id of the entity being affected by maintenance.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of entity.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The API endpoint prefix to use in combination with the entity id to find specific information about the entity.
     *
     * @return self
     */
