...
class InlineObject18 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['size'] = $data['size'] ?? 20;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-zA-Z]((?!--|__)[a-zA-Z0-9-_])+$/", $this->container['label'])) {
     ...
     * Sets region
     *
     * @param string|null $region The Region to deploy this Volume in. This is only required if a linode_id is not given.
     *
     * @return self
     */
     ...
     * Sets linode_id
     *
     * @param int|null $linode_id The Linode this volume should be attached to upon creation. If not given, the volume will be created without an attachment.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The initial size of this volume, in GB.  Be aware that volumes may only be resized up after creation.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string $label The Volume's label, which is also used in the `filesystem_path` of the resulting volume.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject18., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject18., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-zA-Z]((?!--|__)[a-zA-Z0-9-_])+$/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling InlineObject18., must conform to the pattern /^[a-zA-Z]((?!--|__)[a-zA-Z0-9-_])+$/.");
        }
