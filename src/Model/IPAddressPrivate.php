...
/**
 * IPAddressPrivate Class Doc Comment
 *
 * @category Class
 ...
 */
class IPAddressPrivate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPAddressPrivate';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rdns'] = $data['rdns'] ?? null;
     ...
     * Sets address
     *
     * @param string|null $address The private IPv4 address.
     *
     * @return self
     */
     ...
     * Sets gateway
     *
     * @param string|null $gateway The default gateway for this address.
     *
     * @return self
     */
     ...
     * Sets subnet_mask
     *
     * @param string|null $subnet_mask The mask that separates host bits from network bits for this address.
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param int|null $prefix The number of bits set in the subnet mask.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of address this is.
     *
     * @return self
     */
     ...
     * Sets public
     *
     * @param bool|null $public Whether this is a public or private IP address.
     *
     * @return self
     */
     ...
     * Sets rdns
     *
     * @param string|null $rdns The reverse DNS assigned to this address.
     *
     * @return self
     */
     ...
     * Sets linode_id
     *
     * @param int|null $linode_id The ID of the Linode this address currently belongs to.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The Region this address resides in.
     *
     * @return self
     */
