 ...
 *
 * @category Class
 * @description The inbound and outbound access rules to apply to the Firewall.  A Firewall may have up to 25 rules across its inbound and outbound rulesets.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FirewallRules implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Firewall_rules';
    ...
    protected static $openAPITypes = [
        'inbound' => '\ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfig[]',
        'outbound' => '\ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfig[]',
    ...
    protected static $setters = [
        ...
        'inbound_policy' => 'setInboundPolicy',
        'outbound_policy' => 'setOutboundPolicy'
    ];
    ...
    protected static $getters = [
        ...
        'inbound_policy' => 'getInboundPolicy',
        'outbound_policy' => 'getOutboundPolicy'
    ];
    ...
    const INBOUND_POLICY_ACCEPT = 'ACCEPT';
    const INBOUND_POLICY_DROP = 'DROP';
    const OUTBOUND_POLICY_ACCEPT = 'ACCEPT';
    const OUTBOUND_POLICY_DROP = 'DROP';
     ...
     * @return string[]
     */
    public function getInboundPolicyAllowableValues()
    {
        return [
            self::INBOUND_POLICY_ACCEPT,
            self::INBOUND_POLICY_DROP,
        ];
    }
     ...
     * @return string[]
     */
    public function getOutboundPolicyAllowableValues()
    {
        return [
            self::OUTBOUND_POLICY_ACCEPT,
            self::OUTBOUND_POLICY_DROP,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inbound_policy'] = $data['inbound_policy'] ?? null;
        $this->container['outbound_policy'] = $data['outbound_policy'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getInboundPolicyAllowableValues();
        if (!is_null($this->container['inbound_policy']) && !in_array($this->container['inbound_policy'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'inbound_policy', must be one of '%s'",
                $this->container['inbound_policy'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getOutboundPolicyAllowableValues();
        if (!is_null($this->container['outbound_policy']) && !in_array($this->container['outbound_policy'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'outbound_policy', must be one of '%s'",
                $this->container['outbound_policy'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Gets inbound
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfig[]|null
     */
     ...
     * Sets inbound
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfig[]|null $inbound The inbound rules for the firewall, as a JSON array.
     *
     * @return self
     */
     ...
     * Sets outbound
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfig[]|null $outbound The outbound rules for the firewall, as a JSON array.
     *
     * @return self
     */
    ...
    {
        return $this->container['inbound_policy'];
    }

    /**
     * Sets inbound_policy
     *
     * @param string|null $inbound_policy The default behavior for inbound traffic. This setting can be overridden by [updating](/docs/api/networking/#firewall-rules-update) the `inbound.action` property of the Firewall Rule.
     *
     * @return self
     */
    public function setInboundPolicy($inbound_policy)
    {
        $allowedValues = $this->getInboundPolicyAllowableValues();
        if (!is_null($inbound_policy) && !in_array($inbound_policy, $allowedValues, true)) {
        ...
        $this->container['inbound_policy'] = $inbound_policy;

        return $this;
    }

    /**
     * Gets outbound_policy
     *
     * @return string|null
     */
    public function getOutboundPolicy()
    {
        return $this->container['outbound_policy'];
    }

    /**
     * Sets outbound_policy
     *
     * @param string|null $outbound_policy The default behavior for outbound traffic. This setting can be overridden by [updating](/docs/api/networking/#firewall-rules-update) the `outbound.action` property of the Firewall Rule.
     *
     * @return self
     */
    public function setOutboundPolicy($outbound_policy)
    {
        $allowedValues = $this->getOutboundPolicyAllowableValues();
        if (!is_null($outbound_policy) && !in_array($outbound_policy, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'outbound_policy', must be one of '%s'",
                    $outbound_policy,
        ...
        $this->container['outbound_policy'] = $outbound_policy;
