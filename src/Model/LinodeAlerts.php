...
/**
 * LinodeAlerts Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 ...
 */
class LinodeAlerts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Linode_alerts';
    ...
    protected static $setters = [
        'cpu' => 'setCpu',
        'network_in' => 'setNetworkIn',
        'network_out' => 'setNetworkOut',
        'transfer_quota' => 'setTransferQuota',
        'io' => 'setIo'
    ];
    ...
    protected static $getters = [
        ...
        'transfer_quota' => 'getTransferQuota',
        'io' => 'getIo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['network_in'] = $data['network_in'] ?? null;
        $this->container['network_out'] = $data['network_out'] ?? null;
        $this->container['transfer_quota'] = $data['transfer_quota'] ?? null;
        $this->container['io'] = $data['io'] ?? null;
    }
    ...
    {
        return $this->container['network_in'];
    }

    /**
     * Sets network_in
     *
     * @param int|null $network_in The amount of incoming traffic, in Mbit/s, required to trigger an alert. If the average incoming traffic over two hours exceeds this value, we'll send you an alert. If this is set to `0` (zero), the alert is disabled.
     *
     * @return self
     */
    public function setNetworkIn($network_in)
    {
        $this->container['network_in'] = $network_in;
    ...
    {
        return $this->container['network_out'];
    }

    /**
     * Sets network_out
     *
     * @param int|null $network_out The amount of outbound traffic, in Mbit/s, required to trigger an alert. If the average outbound traffic over two hours exceeds this value, we'll send you an alert. If this is set to `0` (zero), the alert is disabled.
     *
     * @return self
     */
    public function setNetworkOut($network_out)
    {
        $this->container['network_out'] = $network_out;
     ...
     * @return int|null
     */
    public function getTransferQuota()
    {
        return $this->container['transfer_quota'];
    }

    /**
     * Sets transfer_quota
     *
     * @param int|null $transfer_quota The percentage of network transfer that may be used before an alert is triggered. When this value is exceeded, we'll alert you. If this is set to `0` (zero), the alert is disabled.
     *
     * @return self
     */
    public function setTransferQuota($transfer_quota)
    {
        $this->container['transfer_quota'] = $transfer_quota;
     ...
     * Sets io
     *
     * @param int|null $io The amount of disk IO operation per second required to trigger an alert. If the average disk IO over two hours exceeds this value, we'll send you an alert. If set to `0` (zero), this alert is disabled.
     *
     * @return self
     */
