...
/**
 * GrantsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class GrantsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GrantsResponse';
    ...
    protected static $openAPITypes = [
        'global' => '\ZoneWatcher\LinodeApiV4\Model\GrantsResponseGlobal',
        'linode' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'domain' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'nodebalancer' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'image' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'longview' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'stackscript' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]',
        'volume' => '\ZoneWatcher\LinodeApiV4\Model\Grant[]'
    ];
    ...
    protected static $setters = [
        ...
        'linode' => 'setLinode',
        'domain' => 'setDomain',
        'nodebalancer' => 'setNodebalancer',
        'image' => 'setImage',
        'longview' => 'setLongview',
    ...
    protected static $getters = [
        ...
        'linode' => 'getLinode',
        'domain' => 'getDomain',
        'nodebalancer' => 'getNodebalancer',
        'image' => 'getImage',
        'longview' => 'getLongview',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['linode'] = $data['linode'] ?? null;
        $this->container['domain'] = $data['domain'] ?? null;
        $this->container['nodebalancer'] = $data['nodebalancer'] ?? null;
        $this->container['image'] = $data['image'] ?? null;
        $this->container['longview'] = $data['longview'] ?? null;
        $this->container['stackscript'] = $data['stackscript'] ?? null;
     ...
     * Gets global
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\GrantsResponseGlobal|null
     */
     ...
     * Sets global
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\GrantsResponseGlobal|null $global global
     *
     * @return self
     */
     ...
     * Gets linode
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Grant[]|null
     */
    public function getLinode()
    {
        return $this->container['linode'];
    }

    /**
     * Sets linode
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $linode The grants this User has pertaining to Linodes on this Account. There will be one entry per Linode on the Account.
     *
     * @return self
     */
    public function setLinode($linode)
    {
        $this->container['linode'] = $linode;
     ...
     * Sets domain
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $domain The grants this User has pertaining to Domains on this Account. There will be one entry per Domain on the Account.
     *
     * @return self
     */
     ...
     * @return \ZoneWatcher\LinodeApiV4\Model\Grant[]|null
     */
    public function getNodebalancer()
    {
        return $this->container['nodebalancer'];
    }

    /**
     * Sets nodebalancer
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $nodebalancer The grants this User has pertaining to NodeBalancers on this Account. There will be one entry per NodeBalancer on the Account.
     *
     * @return self
     */
    public function setNodebalancer($nodebalancer)
    {
        $this->container['nodebalancer'] = $nodebalancer;
     ...
     * Sets image
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $image The grants this User has pertaining to Images on this Account. There will be one entry per Image on the Account.
     *
     * @return self
     */
     ...
     * @return \ZoneWatcher\LinodeApiV4\Model\Grant[]|null
     */
    public function getLongview()
    {
        return $this->container['longview'];
    }

    /**
     * Sets longview
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $longview The grants this User has pertaining to Longview Clients on this Account. There will be one entry per Longview Client on the Account.
     *
     * @return self
     */
    public function setLongview($longview)
    {
        $this->container['longview'] = $longview;
     ...
     * Sets stackscript
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $stackscript The grants this User has pertaining to StackScripts on this Account.  There will be one entry per StackScript on the Account.
     *
     * @return self
     */
     ...
     * Sets volume
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Grant[]|null $volume The grants this User has pertaining to Volumes on this Account. There will be one entry per Volume on the Account.
     *
     * @return self
     */
