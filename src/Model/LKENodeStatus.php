...
/**
 * LKENodeStatus Class Doc Comment
 *
 * @category Class
 ...
 */
class LKENodeStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKENodeStatus';
     ...
     * Sets instance_id
     *
     * @param string|null $instance_id The Linode's ID. When no Linode is currently provisioned for this Node, this will be null.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The Node's status as it pertains to being a Kubernetes node.
     *
     * @return self
     */
