...
/**
 * ManagedContact Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedContact';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'email' => 'string',
        'phone' => '\ZoneWatcher\LinodeApiV4\Model\ManagedContactPhone',
        'group' => 'string',
        'updated' => '\DateTime'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['name']) && !preg_match("/[a-zA-Z0-9-_ ]{2,64}/", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /[a-zA-Z0-9-_ ]{2,64}/.";
        }
        ...
        if (!is_null($this->container['group']) && (mb_strlen($this->container['group']) < 2)) {
     ...
     * Sets id
     *
     * @param int|null $id This Contact's unique ID.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name The name of this Contact.
     *
     * @return self
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ManagedContact., must be smaller than or equal to 64.');
        }
        if (!is_null($name) && (mb_strlen($name) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ManagedContact., must be bigger than or equal to 2.');
        }
        if (!is_null($name) && (!preg_match("/[a-zA-Z0-9-_ ]{2,64}/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ManagedContact., must conform to the pattern /[a-zA-Z0-9-_ ]{2,64}/.");
        }
     ...
     * Sets email
     *
     * @param string|null $email The address to email this Contact to alert them of issues.
     *
     * @return self
     */
     ...
     * Gets phone
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\ManagedContactPhone|null
     */
     ...
     * Sets phone
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\ManagedContactPhone|null $phone phone
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group A grouping for this Contact. This is for display purposes only.
     *
     * @return self
     */
    public function setGroup($group)
    {
        if (!is_null($group) && (mb_strlen($group) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group when calling ManagedContact., must be smaller than or equal to 50.');
        }
        if (!is_null($group) && (mb_strlen($group) < 2)) {
            throw new \InvalidArgumentException('invalid length for $group when calling ManagedContact., must be bigger than or equal to 2.');
        }
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Contact was last updated.
     *
     * @return self
     */
