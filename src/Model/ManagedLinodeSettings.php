...
/**
 * ManagedLinodeSettings Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedLinodeSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedLinodeSettings';
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'group' => 'string',
        'ssh' => '\ZoneWatcher\LinodeApiV4\Model\ManagedLinodeSettingsSsh'
    ];
     ...
     * Sets id
     *
     * @param int|null $id The ID of the Linode these Settings are for.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label of the Linode these Settings are for.
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group The group of the Linode these Settings are for. This is for display purposes only.
     *
     * @return self
     * @deprecated
     */
     ...
     * Gets ssh
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\ManagedLinodeSettingsSsh|null
     */
     ...
     * Sets ssh
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\ManagedLinodeSettingsSsh|null $ssh ssh
     *
     * @return self
     */
