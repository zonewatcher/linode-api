...
class InlineObject2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['promo_code']) > 32)) {
            $invalidProperties[] = "invalid value for 'promo_code', the character length must be smaller than or equal to 32.";
        }
    ...
    {
        if ((mb_strlen($promo_code) > 32)) {
            throw new \InvalidArgumentException('invalid length for $promo_code when calling InlineObject2., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($promo_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $promo_code when calling InlineObject2., must be bigger than or equal to 1.');
        }
