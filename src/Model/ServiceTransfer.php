...
/**
 * ServiceTransfer Class Doc Comment
 *
 * @category Class
 ...
 */
class ServiceTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceTransfer';
    ...
    protected static $openAPITypes = [
        ...
        'is_sender' => 'bool',
        'expiry' => '\DateTime',
        'entities' => '\ZoneWatcher\LinodeApiV4\Model\ServiceTransferEntities'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['is_sender'] = $data['is_sender'] ?? null;
     ...
     * Sets token
     *
     * @param string|null $token The token used to identify and accept or cancel this transfer.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of the transfer request.  `accepted`: The transfer has been accepted by another user and is currently in progress. Transfers can take up to 3 hours to complete.  `cancelled`: The transfer has been cancelled by the sender.  `completed`: The transfer has completed successfully.  `failed`: The transfer has failed after initiation.  `pending`: The transfer is ready to be accepted.  `stale`: The transfer has exceeded its expiration date. It can no longer be accepted or cancelled.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this transfer was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this transfer was last updated.
     *
     * @return self
     */
    ...
    {
        return $this->container['is_sender'];
    }

    /**
     * Sets is_sender
     *
     * @param bool|null $is_sender If the requesting account created this transfer.
     *
     * @return self
     */
    public function setIsSender($is_sender)
    {
        $this->container['is_sender'] = $is_sender;
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry When this transfer expires. Transfers will automatically expire 24 hours after creation.
     *
     * @return self
     */
     ...
     * Gets entities
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\ServiceTransferEntities|null
     */
     ...
     * Sets entities
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\ServiceTransferEntities|null $entities entities
     *
     * @return self
     */
