...
/**
 * ObjectStorageKeyBucketAccess Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 ...
 */
class ObjectStorageKeyBucketAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageKey_bucket_access';
    ...
    const PERMISSIONS_WRITE = 'read_write';
    const PERMISSIONS_ONLY = 'read_only';
     ...
     * Sets cluster
     *
     * @param string|null $cluster The Object Storage cluster where a bucket to which the key is granting access is hosted.
     *
     * @return self
     */
     ...
     * Sets bucket_name
     *
     * @param string|null $bucket_name The unique label of the bucket to which the key will grant limited access.
     *
     * @return self
     */
     ...
     * Sets permissions
     *
     * @param string|null $permissions This Limited Access Key's permissions for the selected bucket.
     *
     * @return self
     */
