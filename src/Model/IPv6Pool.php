 ...
 */
class IPv6Pool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPv6Pool';
     ...
     * Sets prefix
     *
     * @param int|null $prefix The prefix length of the address, denoting how many addresses can be assigned from this pool calculated as 2 <sup>128-prefix</sup>.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region for this pool of IPv6 addresses.
     *
     * @return self
     */
