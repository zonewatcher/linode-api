...
/**
 * ObjectStorageSSL Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectStorageSSL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageSSL';
     ...
     * Sets certificate
     *
     * @param string $certificate Your Base64 encoded and PEM formatted SSL certificate.
     *
     * @return self
     */
     ...
     * Sets private_key
     *
     * @param string $private_key The private key associated with this TLS/SSL certificate.
     *
     * @return self
     */
