...
/**
 * FirewallRuleConfigAddresses Class Doc Comment
 *
 * @category Class
 ...
 */
class FirewallRuleConfigAddresses implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallRuleConfig_addresses';
     ...
     * Sets ipv4
     *
     * @param string[]|null $ipv4 A list of IPv4 addresses or networks. Must be in IP/mask format.
     *
     * @return self
     */
     ...
     * Sets ipv6
     *
     * @param string[]|null $ipv6 A list of IPv6 addresses or networks. Must be in IP/mask format.
     *
     * @return self
     */
