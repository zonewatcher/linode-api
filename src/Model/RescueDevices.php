...
/**
 * RescueDevices Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 ...
 */
class RescueDevices implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RescueDevices';
    ...
    protected static $openAPITypes = [
        'sda' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sdb' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sdc' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sdd' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sde' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sdf' => '\ZoneWatcher\LinodeApiV4\Model\Device',
        'sdg' => '\ZoneWatcher\LinodeApiV4\Model\Device'
    ];
    ...
    {
        $this->container['sda'] = $data['sda'] ?? null;
        $this->container['sdb'] = $data['sdb'] ?? null;
        $this->container['sdc'] = $data['sdc'] ?? null;
        $this->container['sdd'] = $data['sdd'] ?? null;
        $this->container['sde'] = $data['sde'] ?? null;
        $this->container['sdf'] = $data['sdf'] ?? null;
        $this->container['sdg'] = $data['sdg'] ?? null;
    }
     ...
     * Gets sda
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Device|null
     */
    public function getSda()
    {
        return $this->container['sda'];
    }

    /**
     * Sets sda
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sda sda
     *
     * @return self
     */
    public function setSda($sda)
    {
        $this->container['sda'] = $sda;
     ...
     * Sets sdb
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sdb sdb
     *
     * @return self
     */
    ...
    {
        return $this->container['sdc'];
    }

    /**
     * Sets sdc
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sdc sdc
     *
     * @return self
     */
    public function setSdc($sdc)
    {
        $this->container['sdc'] = $sdc;
    ...
    {
        return $this->container['sdd'];
    }

    /**
     * Sets sdd
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sdd sdd
     *
     * @return self
     */
    public function setSdd($sdd)
    {
        $this->container['sdd'] = $sdd;
    ...
    {
        return $this->container['sde'];
    }

    /**
     * Sets sde
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sde sde
     *
     * @return self
     */
    public function setSde($sde)
    {
        $this->container['sde'] = $sde;
    ...
    {
        return $this->container['sdf'];
    }

    /**
     * Sets sdf
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sdf sdf
     *
     * @return self
     */
    public function setSdf($sdf)
    {
        $this->container['sdf'] = $sdf;
    ...
    {
        return $this->container['sdg'];
    }

    /**
     * Sets sdg
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Device|null $sdg sdg
     *
     * @return self
     */
    public function setSdg($sdg)
    {
        $this->container['sdg'] = $sdg;
