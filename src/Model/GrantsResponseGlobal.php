...
/**
 * GrantsResponseGlobal Class Doc Comment
 *
 * @category Class
 ...
 */
class GrantsResponseGlobal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GrantsResponse_global';
    ...
    protected static $openAPIFormats = [
        ...
        'cancel_account' => null,
        'add_domains' => null,
        'add_stackscripts' => null,
        'add_nodebalancers' => null,
        'add_images' => null,
        'add_volumes' => null,
        'add_firewalls' => null
    ];
    ...
    protected static $setters = [
        'add_linodes' => 'setAddLinodes',
        'add_longview' => 'setAddLongview',
        'longview_subscription' => 'setLongviewSubscription',
        'account_access' => 'setAccountAccess',
        'cancel_account' => 'setCancelAccount',
        'add_domains' => 'setAddDomains',
        'add_stackscripts' => 'setAddStackscripts',
        'add_nodebalancers' => 'setAddNodebalancers',
        'add_images' => 'setAddImages',
        'add_volumes' => 'setAddVolumes',
        'add_firewalls' => 'setAddFirewalls'
    ];
    ...
    protected static $getters = [
        'add_linodes' => 'getAddLinodes',
        'add_longview' => 'getAddLongview',
        'longview_subscription' => 'getLongviewSubscription',
        'account_access' => 'getAccountAccess',
        'cancel_account' => 'getCancelAccount',
        'add_domains' => 'getAddDomains',
        'add_stackscripts' => 'getAddStackscripts',
        'add_nodebalancers' => 'getAddNodebalancers',
        'add_images' => 'getAddImages',
        'add_volumes' => 'getAddVolumes',
        'add_firewalls' => 'getAddFirewalls'
    ];
    ...
    const ACCOUNT_ACCESS_ONLY = 'read_only';
    const ACCOUNT_ACCESS_WRITE = 'read_write';
     ...
     * @return string[]
     */
    public function getAccountAccessAllowableValues()
    {
        return [
            self::ACCOUNT_ACCESS_ONLY,
            self::ACCOUNT_ACCESS_WRITE,
        ];
    }
    ...
    {
        $this->container['add_linodes'] = $data['add_linodes'] ?? null;
        $this->container['add_longview'] = $data['add_longview'] ?? null;
        $this->container['longview_subscription'] = $data['longview_subscription'] ?? null;
        $this->container['account_access'] = $data['account_access'] ?? null;
        $this->container['cancel_account'] = $data['cancel_account'] ?? null;
        $this->container['add_domains'] = $data['add_domains'] ?? null;
        $this->container['add_stackscripts'] = $data['add_stackscripts'] ?? null;
        $this->container['add_nodebalancers'] = $data['add_nodebalancers'] ?? null;
        $this->container['add_images'] = $data['add_images'] ?? null;
        $this->container['add_volumes'] = $data['add_volumes'] ?? null;
        $this->container['add_firewalls'] = $data['add_firewalls'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getAccountAccessAllowableValues();
        if (!is_null($this->container['account_access']) && !in_array($this->container['account_access'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'account_access', must be one of '%s'",
                $this->container['account_access'],
     ...
     * @return bool|null
     */
    public function getAddLinodes()
    {
        return $this->container['add_linodes'];
    }

    /**
     * Sets add_linodes
     *
     * @param bool|null $add_linodes If true, this User may create Linodes.
     *
     * @return self
     */
    public function setAddLinodes($add_linodes)
    {
        $this->container['add_linodes'] = $add_linodes;
     ...
     * @return bool|null
     */
    public function getAddLongview()
    {
        return $this->container['add_longview'];
    }

    /**
     * Sets add_longview
     *
     * @param bool|null $add_longview If true, this User may create Longview clients and view the current plan.
     *
     * @return self
     */
    public function setAddLongview($add_longview)
    {
        $this->container['add_longview'] = $add_longview;

        return $this;
    }

    /**
     * Gets longview_subscription
     *
     * @return bool|null
     */
    public function getLongviewSubscription()
    {
        return $this->container['longview_subscription'];
    }

    /**
     * Sets longview_subscription
     *
     * @param bool|null $longview_subscription If true, this User may manage the Account's Longview subscription.
     *
     * @return self
     */
    public function setLongviewSubscription($longview_subscription)
    {
        $this->container['longview_subscription'] = $longview_subscription;
     ...
     * Sets account_access
     *
     * @param string|null $account_access The level of access this User has to Account-level actions, like billing information. A restricted User will never be able to manage users.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getAccountAccessAllowableValues();
        if (!is_null($account_access) && !in_array($account_access, $allowedValues, true)) {
    ...
    {
        return $this->container['cancel_account'];
    }

    /**
     * Sets cancel_account
     *
     * @param bool|null $cancel_account If true, this User may cancel the entire Account.
     *
     * @return self
     */
    public function setCancelAccount($cancel_account)
    {
        $this->container['cancel_account'] = $cancel_account;
     ...
     * @return bool|null
     */
    public function getAddDomains()
    {
        return $this->container['add_domains'];
    }

    /**
     * Sets add_domains
     *
     * @param bool|null $add_domains If true, this User may add Domains.
     *
     * @return self
     */
    public function setAddDomains($add_domains)
    {
        $this->container['add_domains'] = $add_domains;

        return $this;
    }

    /**
     * Gets add_stackscripts
     *
     * @return bool|null
     */
    public function getAddStackscripts()
    {
        return $this->container['add_stackscripts'];
    }

    /**
     * Sets add_stackscripts
     *
     * @param bool|null $add_stackscripts If true, this User may add StackScripts.
     *
     * @return self
     */
    public function setAddStackscripts($add_stackscripts)
    {
        $this->container['add_stackscripts'] = $add_stackscripts;

        return $this;
    }

    /**
     * Gets add_nodebalancers
     *
     * @return bool|null
     */
    public function getAddNodebalancers()
    {
        return $this->container['add_nodebalancers'];
    }

    /**
     * Sets add_nodebalancers
     *
     * @param bool|null $add_nodebalancers If true, this User may add NodeBalancers.
     *
     * @return self
     */
    public function setAddNodebalancers($add_nodebalancers)
    {
        $this->container['add_nodebalancers'] = $add_nodebalancers;
     ...
     * Sets add_images
     *
     * @param bool|null $add_images If true, this User may add Images.
     *
     * @return self
     */
     ...
     * Sets add_volumes
     *
     * @param bool|null $add_volumes If true, this User may add Volumes.
     *
     * @return self
     */
     ...
     * @return bool|null
     */
    public function getAddFirewalls()
    {
        return $this->container['add_firewalls'];
    }

    /**
     * Sets add_firewalls
     *
     * @param bool|null $add_firewalls If true, this User may add Firewalls.
     *
     * @return self
     */
    public function setAddFirewalls($add_firewalls)
    {
        $this->container['add_firewalls'] = $add_firewalls;
