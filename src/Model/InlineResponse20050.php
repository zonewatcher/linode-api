...
class InlineResponse20050 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['acl_xml'] = $data['acl_xml'] ?? null;
    }
     ...
     * Sets acl
     *
     * @param string|null $acl The Access Control Level of the bucket, as a canned ACL string. For more fine-grained control of ACLs, use the S3 API directly.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getAclXml()
    {
        return $this->container['acl_xml'];
    }

    /**
     * Sets acl_xml
     *
     * @param string|null $acl_xml The full XML of the object's ACL policy.
     *
     * @return self
     */
    public function setAclXml($acl_xml)
    {
        $this->container['acl_xml'] = $acl_xml;
