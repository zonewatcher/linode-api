...
class InlineObject9 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets region
     *
     * @param string|null $region This is the Region where the Linode will be deployed. To view all available Regions you can deploy to see [/regions](/docs/api/regions/#regions-list). * Region can only be provided and is required when cloning to a new Linode.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type A Linode's Type determines what resources are available to it, including disk space, memory, and virtual cpus. The amounts available to a specific Linode are returned as `specs` on the Linode object.  To view all available Linode Types you can deploy with see [/linode/types](/docs/api/linode-types/#types-list).  * Type can only be provided and is required when cloning to a new Linode.
     *
     * @return self
     */
     ...
     * Sets linode_id
     *
     * @param int|null $linode_id If an existing Linode is the target for the clone, the ID of that Linode. The existing Linode must have enough resources to accept the clone.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label to assign this Linode when cloning to a new Linode. * Can only be provided when cloning to a new Linode. * Defaults to \"linode\".
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group A label used to group Linodes for display. Linodes are not required to have a group.
     *
     * @return self
     * @deprecated
     */
     ...
     *
     * @param bool|null $backups_enabled If this field is set to `true`, the created Linode will automatically be enrolled in the Linode Backup service. This will incur an additional charge. Pricing is included in the response from [/linodes/types](/docs/api/linode-types/#types-list).  * Can only be included when cloning to a new Linode.
     *
     * @return self
     */
