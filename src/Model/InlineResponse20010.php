...
class InlineResponse20010 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['checkout_token'] = $data['checkout_token'] ?? null;
    }
     ...
     * Sets payment_id
     *
     * @param string|null $payment_id The paypal-generated ID for this Payment. Used when authorizing the Payment in PayPal's interface.
     *
     * @return self
     */
     ...
     * Sets checkout_token
     *
     * @param string|null $checkout_token The checkout token generated for this Payment.
     *
     * @return self
     */
