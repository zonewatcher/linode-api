...
/**
 * WarningObject Class Doc Comment
 *
 * @category Class
 * @description An object for describing a single warning for incomplete processing associated with an accepted request.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class WarningObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WarningObject';
     ...
     * Sets title
     *
     * @param string|null $title The general warning message.
     *
     * @return self
     */
     ...
     * Sets details
     *
     * @param string|null $details Specific information related to the warning.
     *
     * @return self
     */
