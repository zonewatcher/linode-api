...
class Image implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['eol'] = $data['eol'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of this Image.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A short description of the Image.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Image was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Image was last updated.
     *
     * @return self
     */
     ...
     * Sets created_by
     *
     * @param string|null $created_by The name of the User who created this Image, or \"linode\" for public Images.
     *
     * @return self
     */
     ...
     * Sets deprecated
     *
     * @param bool|null $deprecated Whether or not this Image is deprecated. Will only be true for deprecated public Images.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A detailed description of this Image.
     *
     * @return self
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 65000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Image., must be smaller than or equal to 65000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Image., must be bigger than or equal to 1.');
        }
     ...
     * Sets is_public
     *
     * @param bool|null $is_public True if the Image is a public distribution image. False if Image is private Account-specific Image.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The minimum size this Image needs to deploy. Size is in MB.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type How the Image was created.  \"Manual\" Images can be created at any time.  \"Automatic\" Images are created automatically from a deleted Linode.
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry Only Images created automatically from a deleted Linode (type=automatic) will expire.
     *
     * @return self
     */
     ...
     * Sets eol
     *
     * @param \DateTime|null $eol The date of the public Image's planned end of life. `None` for private Images.
     *
     * @return self
     */
     ...
     * Sets vendor
     *
     * @param string|null $vendor The upstream distribution vendor. `None` for private Images.
     *
     * @return self
     */
