...
class SSHKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The unique identifier of an SSH Key object.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A label for the SSH Key.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling SSHKey., must be smaller than or equal to 64.');
        }
        if (!is_null($label) && (mb_strlen($label) < 0)) {
            throw new \InvalidArgumentException('invalid length for $label when calling SSHKey., must be bigger than or equal to 0.');
        }
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date this key was added.
     *
     * @return self
     */
