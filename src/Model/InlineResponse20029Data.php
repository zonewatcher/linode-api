 ...
 *
 * @category Class
 * @description The selected node in the cluster.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class InlineResponse20029Data implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id The Node's ID.
     *
     * @return self
     */
     ...
     * Sets instance_id
     *
     * @param int|null $instance_id The Linode's ID. If no Linode is currently provisioned for this Node, this is `null`.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The creation status of this Node. This status is distinct from this Node's readiness as a Kubernetes Node Object as determined by the command `kubectl get nodes`.  `not_ready` indicates that the Linode is still being created.  `ready` indicates that the Linode has successfully been created and is running Kubernetes software.
     *
     * @return self
     */
