...
class Domain implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'soa_email' => 'setSoaEmail',
        'retry_sec' => 'setRetrySec',
        'master_ips' => 'setMasterIps',
        'axfr_ips' => 'setAxfrIps',
        'expire_sec' => 'setExpireSec',
        'refresh_sec' => 'setRefreshSec',
        'ttl_sec' => 'setTtlSec',
        'tags' => 'setTags'
    ];
    ...
    protected static $getters = [
        ...
        'soa_email' => 'getSoaEmail',
        'retry_sec' => 'getRetrySec',
        'master_ips' => 'getMasterIps',
        'axfr_ips' => 'getAxfrIps',
        'expire_sec' => 'getExpireSec',
        'refresh_sec' => 'getRefreshSec',
        'ttl_sec' => 'getTtlSec',
        'tags' => 'getTags'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = $data['status'] ?? 'active';
        $this->container['description'] = $data['description'] ?? null;
        $this->container['soa_email'] = $data['soa_email'] ?? null;
        $this->container['retry_sec'] = $data['retry_sec'] ?? 0;
        $this->container['master_ips'] = $data['master_ips'] ?? null;
        $this->container['axfr_ips'] = $data['axfr_ips'] ?? null;
        $this->container['expire_sec'] = $data['expire_sec'] ?? 0;
        $this->container['refresh_sec'] = $data['refresh_sec'] ?? 0;
        $this->container['ttl_sec'] = $data['ttl_sec'] ?? 0;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['domain']) && !preg_match("/\\A(\\*\\.)?([a-zA-Z0-9-_]{1,63}\\.)+([a-zA-Z]{2,3}\\.)?([a-zA-Z]{2,16}|xn--[a-zA-Z0-9]+)\\Z/", $this->container['domain'])) {
            $invalidProperties[] = "invalid value for 'domain', must be conform to the pattern /\\A(\\*\\.)?([a-zA-Z0-9-_]{1,63}\\.)+([a-zA-Z]{2,3}\\.)?([a-zA-Z]{2,16}|xn--[a-zA-Z0-9]+)\\Z/.";
        }

        if (!is_null($this->container['group']) && (mb_strlen($this->container['group']) > 50)) {
            $invalidProperties[] = "invalid value for 'group', the character length must be smaller than or equal to 50.";
        }
     ...
     * Sets id
     *
     * @param int|null $id This Domain's unique ID
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Whether this Domain represents the authoritative source of information for the domain it describes (\"master\"), or whether it is a read-only copy of a master (\"slave\").
     *
     * @return self
     */
    ...
    public function setDomain($domain)
    {
        if (!is_null($domain) && (mb_strlen($domain) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling Domain., must be smaller than or equal to 255.');
        }
        if (!is_null($domain) && (mb_strlen($domain) < 1)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling Domain., must be bigger than or equal to 1.');
        }
        if (!is_null($domain) && (!preg_match("/\\A(\\*\\.)?([a-zA-Z0-9-_]{1,63}\\.)+([a-zA-Z]{2,3}\\.)?([a-zA-Z]{2,16}|xn--[a-zA-Z0-9]+)\\Z/", $domain))) {
            throw new \InvalidArgumentException("invalid value for $domain when calling Domain., must conform to the pattern /\\A(\\*\\.)?([a-zA-Z0-9-_]{1,63}\\.)+([a-zA-Z]{2,3}\\.)?([a-zA-Z]{2,16}|xn--[a-zA-Z0-9]+)\\Z/.");
        }
     ...
     * Sets group
     *
     * @param string|null $group The group this Domain belongs to.  This is for display purposes only.
     *
     * @return self
     * @deprecated
     */
    ...
    {
        if (!is_null($group) && (mb_strlen($group) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group when calling Domain., must be smaller than or equal to 50.');
        }
        if (!is_null($group) && (mb_strlen($group) < 1)) {
            throw new \InvalidArgumentException('invalid length for $group when calling Domain., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Used to control whether this Domain is currently being rendered.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A description for this Domain. This is for display purposes only.
     *
     * @return self
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Domain., must be smaller than or equal to 255.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Domain., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['soa_email'];
    }

    /**
     * Sets soa_email
     *
     * @param string|null $soa_email Start of Authority email address. This is required for `type` master Domains.
     *
     * @return self
     */
    public function setSoaEmail($soa_email)
    {
        $this->container['soa_email'] = $soa_email;
     ...
     * @return int|null
     */
    public function getRetrySec()
    {
        return $this->container['retry_sec'];
    }

    /**
     * Sets retry_sec
     *
     * @param int|null $retry_sec The interval, in seconds, at which a failed refresh should be retried.  * Valid values are 0, 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200.  * Any other value is rounded up to the nearest valid value.  * A value of 0 is equivalent to the default value of 14400.
     *
     * @return self
     */
    public function setRetrySec($retry_sec)
    {
        $this->container['retry_sec'] = $retry_sec;
    ...
    {
        return $this->container['master_ips'];
    }

    /**
     * Sets master_ips
     *
     * @param string[]|null $master_ips The IP addresses representing the master DNS for this Domain. At least one value is required for `type` slave Domains.
     *
     * @return self
     */
    public function setMasterIps($master_ips)
    {
        $this->container['master_ips'] = $master_ips;
    ...
    {
        return $this->container['axfr_ips'];
    }

    /**
     * Sets axfr_ips
     *
     * @param string[]|null $axfr_ips The list of IPs that may perform a zone transfer for this Domain. This is potentially dangerous, and should be set to an empty list unless you intend to use it.
     *
     * @return self
     */
    public function setAxfrIps($axfr_ips)
    {
        $this->container['axfr_ips'] = $axfr_ips;
     ...
     * @return int|null
     */
    public function getRefreshSec()
    {
        return $this->container['refresh_sec'];
    }

    /**
     * Sets refresh_sec
     *
     * @param int|null $refresh_sec The amount of time in seconds before this Domain should be refreshed.  * Valid values are 0, 300, 3600, 7200, 14400, 28800, 57600, 86400, 172800, 345600, 604800, 1209600, and 2419200.  * Any other value is rounded up to the nearest valid value.  * A value of 0 is equivalent to the default value of 14400.
     *
     * @return self
     */
    public function setRefreshSec($refresh_sec)
    {
        $this->container['refresh_sec'] = $refresh_sec;
     ...
     * Sets tags
     *
     * @param string[]|null $tags An array of tags applied to this object.  Tags are for organizational purposes only.
     *
     * @return self
     */
