 ...
 */
class ObjectStorageKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageKey';
    ...
    protected static $openAPITypes = [
        ...
        'secret_key' => 'string',
        'limited' => 'bool',
        'bucket_access' => '\ZoneWatcher\LinodeApiV4\Model\ObjectStorageKeyBucketAccess[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['limited'] = $data['limited'] ?? null;
        $this->container['bucket_access'] = $data['bucket_access'] ?? null;
    }
     ...
     * Sets id
     *
     * @param int|null $id This keypair's unique ID
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label given to this key. For display purposes only.
     *
     * @return self
     */
     ...
     * Sets access_key
     *
     * @param string|null $access_key This keypair's access key. This is not secret.
     *
     * @return self
     */
     ...
     * Sets secret_key
     *
     * @param string|null $secret_key This keypair's secret key. Only returned on key creation.
     *
     * @return self
     */
     ...
     * Sets limited
     *
     * @param bool|null $limited Whether or not this key is a limited access key. Will return `false` if this key grants full access to all buckets on the user's account.
     *
     * @return self
     */
