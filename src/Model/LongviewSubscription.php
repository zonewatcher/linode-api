...
/**
 * LongviewSubscription Class Doc Comment
 *
 * @category Class
 ...
 */
class LongviewSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongviewSubscription';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'price' => '\ZoneWatcher\LinodeApiV4\Model\LongviewSubscriptionPrice',
        'label' => 'string',
    ...
    protected static $setters = [
        ...
        'price' => 'setPrice',
        'label' => 'setLabel',
        'clients_included' => 'setClientsIncluded'
    ];
    ...
    protected static $getters = [
        ...
        'price' => 'getPrice',
        'label' => 'getLabel',
        'clients_included' => 'getClientsIncluded'
    ];
    ...
    const ID__3 = 'longview-3';
    const ID__10 = 'longview-10';
    const ID__40 = 'longview-40';
    const ID__100 = 'longview-100';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['clients_included'] = $data['clients_included'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of this Subscription tier.
     *
     * @return self
     */
     ...
     * Gets price
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LongviewSubscriptionPrice|null
     */
     ...
     * Sets price
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LongviewSubscriptionPrice|null $price price
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A display name for this Subscription tier.
     *
     * @return self
     */
    ...
    /**
     * Gets clients_included
     *
     * @return int|null
     */
    public function getClientsIncluded()
    {
        return $this->container['clients_included'];
    }

    /**
     * Sets clients_included
     *
     * @param int|null $clients_included The number of Longview Clients that may be created with this Subscription tier.
     *
     * @return self
     */
    public function setClientsIncluded($clients_included)
    {
        $this->container['clients_included'] = $clients_included;
