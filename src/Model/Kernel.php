 ...
 */
class Kernel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Kernel';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['kvm'] = $data['kvm'] ?? null;
        $this->container['xen'] = $data['xen'] ?? null;
        $this->container['architecture'] = $data['architecture'] ?? null;
        $this->container['pvops'] = $data['pvops'] ?? null;
        $this->container['deprecated'] = $data['deprecated'] ?? null;
        $this->container['built'] = $data['built'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of this Kernel.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The friendly name of this Kernel.
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version Linux Kernel version.
     *
     * @return self
     */
     ...
     * Sets kvm
     *
     * @param bool|null $kvm If this Kernel is suitable for KVM Linodes.
     *
     * @return self
     */
     ...
     * Sets xen
     *
     * @param bool|null $xen If this Kernel is suitable for Xen Linodes.
     *
     * @return self
     */
     ...
     * Sets architecture
     *
     * @param string|null $architecture The architecture of this Kernel.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getArchitectureAllowableValues();
        if (!is_null($architecture) && !in_array($architecture, $allowedValues, true)) {
     ...
     * @return bool|null
     */
    public function getPvops()
    {
        return $this->container['pvops'];
    }

    /**
     * Sets pvops
     *
     * @param bool|null $pvops If this Kernel is suitable for paravirtualized operations.
     *
     * @return self
     */
    public function setPvops($pvops)
    {
        $this->container['pvops'] = $pvops;
     ...
     * Sets deprecated
     *
     * @param bool|null $deprecated If this Kernel is marked as deprecated, this field has a value of true; otherwise, this field is false.
     *
     * @return self
     */
     ...
     * Sets built
     *
     * @param \DateTime|null $built The date on which this Kernel was built.
     *
     * @return self
     */
