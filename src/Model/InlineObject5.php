...
class InlineObject5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets region
     *
     * @param string $region The region to upload to. Once uploaded, the Image can be used in any region.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Description for the uploaded Image.
     *
     * @return self
     */
