...
/**
 * NodeBalancerNode Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancerNode';
     ...
     * Sets id
     *
     * @param int|null $id This node's unique ID.
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address The private IP Address where this backend can be reached. This _must_ be a private IP address.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label for this node.  This is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling NodeBalancerNode., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling NodeBalancerNode., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/[a-zA-Z0-9-_.]{3,32}/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling NodeBalancerNode., must conform to the pattern /[a-zA-Z0-9-_.]{3,32}/.");
        }
     ...
     * Sets status
     *
     * @param string|null $status The current status of this node, based on the configured checks of its NodeBalancer Config.
     *
     * @return self
     */
     ...
     * Sets weight
     *
     * @param int|null $weight Used when picking a backend to serve a request and is not pinned to a single backend yet.  Nodes with a higher weight will receive more traffic.
     *
     * @return self
     */
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight > 255)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling NodeBalancerNode., must be smaller than or equal to 255.');
        }
        if (!is_null($weight) && ($weight < 1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling NodeBalancerNode., must be bigger than or equal to 1.');
        }
     ...
     * Sets config_id
     *
     * @param int|null $config_id The NodeBalancer Config ID that this Node belongs to.
     *
     * @return self
     */
     ...
     *
     * @param int|null $nodebalancer_id The NodeBalancer ID that this Node belongs to.
     *
     * @return self
     */
