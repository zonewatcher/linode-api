...
class InvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets amount
     *
     * @param float|null $amount The price, in US dollars, of the Invoice Item. Equal to the unit price multiplied by quantity.
     *
     * @return self
     */
     ...
     * Sets tax
     *
     * @param float|null $tax The amount of tax levied on this Item in US Dollars.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total The price of this Item after taxes in US Dollars.
     *
     * @return self
     */
     ...
     * Sets from
     *
     * @param \DateTime|null $from The date the Invoice Item started, based on month.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The Invoice Item's display label.
     *
     * @return self
     */
     ...
     * Sets quantity
     *
     * @param int|null $quantity The quantity of this Item for the specified Invoice.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param \DateTime|null $to The date the Invoice Item ended, based on month.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of service, ether `hourly` or `misc`.
     *
     * @return self
     */
     ...
     * Sets unit_price
     *
     * @param string|null $unit_price The monthly service fee in US Dollars for this Item.
     *
     * @return self
     */
