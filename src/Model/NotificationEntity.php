...
/**
 * NotificationEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class NotificationEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Notification_entity';
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the Notification's entity, based on the entity type.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The current label for this Notification's entity.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of entity this is related to.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL where you can access the object this Notification is for. If a relative URL, it is relative to the domain you retrieved the Notification from.
     *
     * @return self
     */
