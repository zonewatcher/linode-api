...
class Backup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'configs' => 'string[]',
        'disks' => '\ZoneWatcher\LinodeApiV4\Model\BackupDisks[]'
    ];
    ...
    const STATUS_NEEDS_POST_PROCESSING = 'needsPostProcessing';
    const STATUS_SUCCESSFUL = 'successful';
    const STATUS_FAILED = 'failed';
    const STATUS_USER_ABORTED = 'userAborted';
    ...
    public function getStatusAllowableValues()
    {
        return [
            ...
            self::STATUS_PENDING,
            self::STATUS_RUNNING,
            self::STATUS_NEEDS_POST_PROCESSING,
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this Backup.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type This indicates whether the Backup is an automatic Backup or manual snapshot taken by the User at a specific point in time.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The current state of a specific Backup.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date the Backup was taken.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated The date the Backup was most recently updated.
     *
     * @return self
     */
     ...
     * Sets finished
     *
     * @param \DateTime|null $finished The date the Backup completed.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A label for Backups that are of type `snapshot`.
     *
     * @return self
     */
     ...
     * Sets configs
     *
     * @param string[]|null $configs A list of the labels of the Configuration profiles that are part of the Backup.
     *
     * @return self
     */
     ...
     * Gets disks
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\BackupDisks[]|null
     */
     ...
     * Sets disks
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\BackupDisks[]|null $disks A list of the disks that are part of the Backup.
     *
     * @return self
     */
