...
/**
 * LinodeTypeAddonsBackupsPrice Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeTypeAddonsBackupsPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeType_addons_backups_price';
     ...
     * Sets hourly
     *
     * @param int|null $hourly The cost (in US dollars) per hour to add Backups service.
     *
     * @return self
     */
     ...
     * Sets monthly
     *
     * @param int|null $monthly The cost (in US dollars) per month to add Backups service.
     *
     * @return self
     */
