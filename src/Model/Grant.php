...
class Grant implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The ID of the entity this grant applies to.
     *
     * @return self
     */
     ...
     * Sets permissions
     *
     * @param string|null $permissions The level of access this User has to this entity.  If null, this User has no access.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The current label of the entity this grant applies to, for display purposes.
     *
     * @return self
     */
