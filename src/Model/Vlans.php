 ...
 */
class Vlans implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Vlans';
     ...
     * Sets label
     *
     * @param string|null $label The name of this VLAN.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region This VLAN's data center region.  **Note:** Currently, a VLAN can only be assigned to a Linode within the same data center region.
     *
     * @return self
     */
     ...
     * Sets linodes
     *
     * @param int[]|null $linodes An array of Linode IDs attached to this VLAN.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date this VLAN was created.
     *
     * @return self
     */
