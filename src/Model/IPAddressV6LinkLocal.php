...
/**
 * IPAddressV6LinkLocal Class Doc Comment
 *
 * @category Class
 ...
 */
class IPAddressV6LinkLocal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPAddressV6LinkLocal';
     ...
     * Sets address
     *
     * @param string|null $address The IPv6 link-local address.
     *
     * @return self
     */
     ...
     * Sets subnet_mask
     *
     * @param string|null $subnet_mask The subnet mask.
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param int|null $prefix The network prefix.
     *
     * @return self
     */
