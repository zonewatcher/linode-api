...
/**
 * LinodeTypeAddonsBackups Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeTypeAddonsBackups implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeType_addons_backups';
    ...
    protected static $openAPITypes = [
        'price' => '\ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddonsBackupsPrice'
    ];
     ...
     * Gets price
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddonsBackupsPrice|null
     */
     ...
     * Sets price
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddonsBackupsPrice|null $price price
     *
     * @return self
     */
