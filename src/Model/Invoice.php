...
class Invoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The Invoice's unique ID.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date When this Invoice was generated.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The Invoice's display label.
     *
     * @return self
     */
     ...
     * Sets subtotal
     *
     * @param float|null $subtotal The amount of the Invoice before taxes in US Dollars.
     *
     * @return self
     */
     ...
     * Sets tax
     *
     * @param float|null $tax The amount of tax levied on the Invoice in US Dollars.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total The amount of the Invoice after taxes in US Dollars.
     *
     * @return self
     */
