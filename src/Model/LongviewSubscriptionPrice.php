...
/**
 * LongviewSubscriptionPrice Class Doc Comment
 *
 * @category Class
 ...
 */
class LongviewSubscriptionPrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongviewSubscription_price';
    ...
    {
        $this->container['hourly'] = $data['hourly'] ?? null;
     ...
     * Sets hourly
     *
     * @param float|null $hourly The hourly price, in US dollars, for this Subscription tier.
     *
     * @return self
     */
     ...
     * Sets monthly
     *
     * @param float|null $monthly The maximum monthly price in US Dollars for this Subscription tier. You will never be charged more than this amount per month for this subscription.
     *
     * @return self
     */
