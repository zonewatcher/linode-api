...
class InlineObject17 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'domains' => 'setDomains',
        'volumes' => 'setVolumes',
        'nodebalancers' => 'setNodebalancers'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['linodes'] = $data['linodes'] ?? null;
        $this->container['domains'] = $data['domains'] ?? null;
        $this->container['volumes'] = $data['volumes'] ?? null;
        $this->container['nodebalancers'] = $data['nodebalancers'] ?? null;
    }
     ...
     * Sets label
     *
     * @param string $label The new Tag.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject17., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InlineObject17., must be bigger than or equal to 3.');
        }
    ...
    {
        return $this->container['linodes'];
    }

    /**
     * Sets linodes
     *
     * @param int[]|null $linodes A list of Linode IDs to apply the new Tag to.  You must be allowed to `read_write` all of the requested Linodes, or the Tag will not be created and an error will be returned.
     *
     * @return self
     */
    public function setLinodes($linodes)
    {
        $this->container['linodes'] = $linodes;
     ...
     * Sets domains
     *
     * @param int[]|null $domains A list of Domain IDs to apply the new Tag to.  You must be allowed to `read_write` all of the requested Domains, or the Tag will not be created and an error will be returned.
     *
     * @return self
     */
     ...
     * Sets volumes
     *
     * @param int[]|null $volumes A list of Volume IDs to apply the new Tag to.  You must be allowed to `read_write` all of the requested Volumes, or the Tag will not be created and an error will be returned.
     *
     * @return self
     */
     ...
     * @return int[]|null
     */
    public function getNodebalancers()
    {
        return $this->container['nodebalancers'];
    }

    /**
     * Sets nodebalancers
     *
     * @param int[]|null $nodebalancers A list of NodeBalancer IDs to apply the new Tag to. You must be allowed to `read_write` all of the requested NodeBalancers, or the Tag will not be created and an error will be returned.
     *
     * @return self
     */
    public function setNodebalancers($nodebalancers)
    {
        $this->container['nodebalancers'] = $nodebalancers;
