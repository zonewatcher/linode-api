 ...
 */
class EventEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Event_entity';
    ...
    const TYPE_DISKS = 'disks';
    const TYPE_DOMAIN = 'domain';
    const TYPE_ENTITY_TRANSFER = 'entity_transfer';
    const TYPE_FIREWALL = 'firewall';
    const TYPE_IMAGE = 'image';
    const TYPE_IPADDRESS = 'ipaddress';
    const TYPE_LINODE = 'linode';
    const TYPE_LONGVIEW = 'longview';
    const TYPE_MANAGED_SERVICE = 'managed_service';
    const TYPE_NODEBALANCER = 'nodebalancer';
    const TYPE_OAUTH_CLIENT = 'oauth_client';
    const TYPE_PROFILE = 'profile';
    const TYPE_STACKSCRIPT = 'stackscript';
    const TYPE_TAG = 'tag';
    const TYPE_TICKET = 'ticket';
    const TYPE_TOKEN = 'token';
    const TYPE_USER = 'user';
    const TYPE_USER_SSH_KEY = 'user_ssh_key';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_DISKS,
            self::TYPE_DOMAIN,
            self::TYPE_ENTITY_TRANSFER,
            self::TYPE_FIREWALL,
            self::TYPE_IMAGE,
            self::TYPE_IPADDRESS,
            self::TYPE_LINODE,
            self::TYPE_LONGVIEW,
            self::TYPE_MANAGED_SERVICE,
            self::TYPE_NODEBALANCER,
            self::TYPE_OAUTH_CLIENT,
            self::TYPE_PROFILE,
            self::TYPE_STACKSCRIPT,
            self::TYPE_TAG,
            self::TYPE_TICKET,
            self::TYPE_TOKEN,
            self::TYPE_USER,
            self::TYPE_USER_SSH_KEY,
            self::TYPE_VOLUME,
        ];
    }
     ...
     * Sets label
     *
     * @param string|null $label The current label of this object. The label may reflect changes that occur with this Event.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of entity that is being referenced by the Event.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL where you can access the object this Event is for. If a relative URL, it is relative to the domain you retrieved the Event from.
     *
     * @return self
     */
