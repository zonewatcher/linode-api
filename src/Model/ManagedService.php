...
class ManagedService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'timeout' => 'setTimeout',
        'body' => 'setBody',
        'consultation_group' => 'setConsultationGroup',
        'notes' => 'setNotes',
        'region' => 'setRegion',
    ...
    protected static $getters = [
        ...
        'timeout' => 'getTimeout',
        'body' => 'getBody',
        'consultation_group' => 'getConsultationGroup',
        'notes' => 'getNotes',
        'region' => 'getRegion',
    ...
    const SERVICE_TYPE_URL = 'url';
    const SERVICE_TYPE_TCP = 'tcp';
    ...
    {
        return [
            self::SERVICE_TYPE_URL,
            self::SERVICE_TYPE_TCP,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['consultation_group'] = $data['consultation_group'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label']) && (mb_strlen($this->container['label']) < 3)) {
            $invalidProperties[] = "invalid value for 'label', the character length must be bigger than or equal to 3.";
        }

        if (!is_null($this->container['label']) && !preg_match("/[a-zA-Z0-9-_ \\.]{3,64}/", $this->container['label'])) {
            $invalidProperties[] = "invalid value for 'label', must be conform to the pattern /[a-zA-Z0-9-_ \\.]{3,64}/.";
        }
        ...
        if (!is_null($this->container['timeout']) && ($this->container['timeout'] > 255)) {
            $invalidProperties[] = "invalid value for 'timeout', must be smaller than or equal to 255.";
        }
        ...
        if (!is_null($this->container['body']) && (mb_strlen($this->container['body']) > 100)) {
            $invalidProperties[] = "invalid value for 'body', the character length must be smaller than or equal to 100.";
        }
        ...
        if (!is_null($this->container['consultation_group']) && (mb_strlen($this->container['consultation_group']) > 50)) {
            $invalidProperties[] = "invalid value for 'consultation_group', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['consultation_group']) && (mb_strlen($this->container['consultation_group']) < 0)) {
            $invalidProperties[] = "invalid value for 'consultation_group', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets id
     *
     * @param int|null $id This Service's unique ID.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The current status of this Service.
     *
     * @return self
     */
     ...
     * Sets service_type
     *
     * @param string|null $service_type How this Service is monitored.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The label for this Service. This is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ManagedService., must be smaller than or equal to 64.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ManagedService., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/[a-zA-Z0-9-_ \\.]{3,64}/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling ManagedService., must conform to the pattern /[a-zA-Z0-9-_ \\.]{3,64}/.");
        }
     ...
     * Sets address
     *
     * @param string|null $address The URL at which this Service is monitored.  URL parameters such as `?no-cache=1` are preserved.  URL fragments/anchors such as `#monitor` are **not** preserved.
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) < 3)) {
            throw new \InvalidArgumentException('invalid length for $address when calling ManagedService., must be bigger than or equal to 3.');
        }
     ...
     * Sets timeout
     *
     * @param int|null $timeout How long to wait, in seconds, for a response before considering the Service to be down.
     *
     * @return self
     */
    public function setTimeout($timeout)
    {
        ...
        if (!is_null($timeout) && ($timeout > 255)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling ManagedService., must be smaller than or equal to 255.');
        }
        if (!is_null($timeout) && ($timeout < 1)) {
            throw new \InvalidArgumentException('invalid value for $timeout when calling ManagedService., must be bigger than or equal to 1.');
        }
     ...
     * Sets body
     *
     * @param string|null $body What to expect to find in the response body for the Service to be considered up.
     *
     * @return self
     */
    public function setBody($body)
    {
        if (!is_null($body) && (mb_strlen($body) > 100)) {
            throw new \InvalidArgumentException('invalid length for $body when calling ManagedService., must be smaller than or equal to 100.');
        }
        if (!is_null($body) && (mb_strlen($body) < 0)) {
            throw new \InvalidArgumentException('invalid length for $body when calling ManagedService., must be bigger than or equal to 0.');
        }
    ...
    /**
     * Gets consultation_group
     *
     * @return string|null
     */
    public function getConsultationGroup()
    {
        return $this->container['consultation_group'];
    }

    /**
     * Sets consultation_group
     *
     * @param string|null $consultation_group The group of ManagedContacts who should be notified or consulted with when an Issue is detected.
     *
     * @return self
     */
    public function setConsultationGroup($consultation_group)
    {
        if (!is_null($consultation_group) && (mb_strlen($consultation_group) > 50)) {
            throw new \InvalidArgumentException('invalid length for $consultation_group when calling ManagedService., must be smaller than or equal to 50.');
        }
        if (!is_null($consultation_group) && (mb_strlen($consultation_group) < 0)) {
            throw new \InvalidArgumentException('invalid length for $consultation_group when calling ManagedService., must be bigger than or equal to 0.');
        }

        $this->container['consultation_group'] = $consultation_group;
     ...
     * Sets notes
     *
     * @param string|null $notes Any information relevant to the Service that Linode special forces should know when attempting to resolve Issues.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The Region in which this Service is located. This is required if address is a private IP, and may not be set otherwise.
     *
     * @return self
     */
     ...
     * Sets credentials
     *
     * @param int[]|null $credentials An array of ManagedCredential IDs that should be used when attempting to resolve issues with this Service.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Managed Service was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Managed Service was last updated.
     *
     * @return self
     */
