...
class InlineObject15 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['cors_enabled'] = $data['cors_enabled'] ?? false;
        $this->container['acl'] = $data['acl'] ?? 'private';
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[a-z0-09][a-z0-9-]*[a-z0-9]?$/", $this->container['label'])) {
            $invalidProperties[] = "invalid value for 'label', must be conform to the pattern /^[a-z0-09][a-z0-9-]*[a-z0-9]?$/.";
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((!preg_match("/^[a-z0-09][a-z0-9-]*[a-z0-9]?$/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling InlineObject15., must conform to the pattern /^[a-z0-09][a-z0-9-]*[a-z0-9]?$/.");
        }
     ...
     * Sets cluster
     *
     * @param string $cluster The ID of the Object Storage Cluster where this bucket should be created.
     *
     * @return self
     */
    ...
    {
        return $this->container['cors_enabled'];
    }

    /**
     * Sets cors_enabled
     *
     * @param bool|null $cors_enabled If true, the bucket will be created with CORS enabled for all origins. For more fine-grained controls of CORS, use the S3 API directly.
     *
     * @return self
     */
    public function setCorsEnabled($cors_enabled)
    {
        $this->container['cors_enabled'] = $cors_enabled;
     ...
     * Sets acl
     *
     * @param string|null $acl The Access Control Level of the bucket using a canned ACL string. For more fine-grained control of ACLs, use the S3 API directly.
     *
     * @return self
     */
