...
/**
 * ProfileReferrals Class Doc Comment
 *
 * @category Class
 * @description Information about your status in our referral program.  This information becomes accessible after this Profile&#39;s Account has established at least $25.00 USD of total payments.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ProfileReferrals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_referrals';
     ...
     * Sets code
     *
     * @param string|null $code Your referral code.  If others use this when signing up for Linode, you will receive account credit.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Your referral url, used to direct others to sign up for Linode with your referral code.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param int|null $total The number of users who have signed up with your referral code.
     *
     * @return self
     */
     ...
     * Sets completed
     *
     * @param int|null $completed The number of completed signups with your referral code.
     *
     * @return self
     */
     ...
     * Sets pending
     *
     * @param int|null $pending The number of pending signups with your referral code.  You will not receive credit for these signups until they are completed.
     *
     * @return self
     */
     ...
     * Sets credit
     *
     * @param int|null $credit The amount of account credit in US Dollars issued to you through the referral program.
     *
     * @return self
     */
