...
class IPAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const TYPE_IPV6_POOL = 'ipv6/pool';
    const TYPE_IPV6_RANGE = 'ipv6/range';
     ...
     * Sets rdns
     *
     * @param string|null $rdns The reverse DNS assigned to this address. For public IPv4 addresses, this will be set to a default value provided by Linode if not explicitly set.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The Region this IP address resides in.
     *
     * @return self
     */
