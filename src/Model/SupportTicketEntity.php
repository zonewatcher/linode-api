...
/**
 * SupportTicketEntity Class Doc Comment
 *
 * @category Class
 ...
 */
class SupportTicketEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupportTicket_entity';
     ...
     * Sets id
     *
     * @param int|null $id The unique ID for this Ticket's entity.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The current label of this entity.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url The URL where you can access the object this event is for. If a relative URL, it is relative to the domain you retrieved the entity from.
     *
     * @return self
     */
