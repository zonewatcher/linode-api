...
class InlineObject1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'is_default' => '\ZoneWatcher\LinodeApiV4\Model\IsDefault',
        'data' => '\ZoneWatcher\LinodeApiV4\Model\CreditCard'
    ];
     ...
     * Sets type
     *
     * @param string $type The type of Payment Method.  Alternative Payment Methods including Google Pay can be added using Linode Cloud Manager. See our guide on [Managing Billing in the Cloud Manager](/docs/guides/manage-billing-in-cloud-manager/) for details and instructions.
     *
     * @return self
     */
     ...
     * Gets is_default
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\IsDefault
     */
     ...
     * Sets is_default
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\IsDefault $is_default is_default
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\CreditCard
     */
     ...
     * Sets data
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\CreditCard $data data
     *
     * @return self
     */
