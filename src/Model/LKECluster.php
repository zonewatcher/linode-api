 ...
 */
class LKECluster implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKECluster';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['k8s_version'] = $data['k8s_version'] ?? null;
     ...
     * Sets id
     *
     * @param int|null $id This Kubernetes cluster's unique ID.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Kubernetes cluster was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Kubernetes cluster was updated.
     *
     * @return self
     */
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling LKECluster., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling LKECluster., must be bigger than or equal to 1.');
        }
     ...
     * Sets region
     *
     * @param string|null $region This Kubernetes cluster's location.
     *
     * @return self
     */
     ...
     * Sets k8s_version
     *
     * @param string|null $k8s_version The desired Kubernetes version for this Kubernetes cluster in the format of &lt;major&gt;.&lt;minor&gt;, and the latest supported patch version will be deployed.
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string[]|null $tags An array of tags applied to the Kubernetes cluster. Tags are for organizational purposes only.
     *
     * @return self
     */
