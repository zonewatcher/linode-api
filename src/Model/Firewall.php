...
class Firewall implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'updated' => '\DateTime',
        'status' => 'string',
        'rules' => '\ZoneWatcher\LinodeApiV4\Model\FirewallRules',
        'tags' => 'string[]'
    ];
     ...
     * Sets id
     *
     * @param int|null $id The Firewall's unique ID.
     *
     * @return self
     */
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Firewall., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Firewall., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling Firewall., must conform to the pattern /^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/.");
        }
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Firewall was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Firewall was last updated.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The status of this Firewall.    * When a Firewall is first created its status is `enabled`.   * Use the [Update Firewall](/docs/api/networking/#firewall-update) endpoint to set a Firewall's status to `enabled` or `disabled`.   * Use the [Delete Firewall](/docs/api/networking/#firewall-delete) endpoint to delete a Firewall.
     *
     * @return self
     */
     ...
     * Gets rules
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\FirewallRules|null
     */
     ...
     * Sets rules
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\FirewallRules|null $rules rules
     *
     * @return self
     */
