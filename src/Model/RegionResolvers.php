...
/**
 * RegionResolvers Class Doc Comment
 *
 * @category Class
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 ...
 */
class RegionResolvers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Region_resolvers';
     ...
     * Sets ipv4
     *
     * @param string|null $ipv4 The IPv4 addresses for this region's DNS resolvers, separated by commas.
     *
     * @return self
     */
     ...
     * Sets ipv6
     *
     * @param string|null $ipv6 The IPv6 addresses for this region's DNS resolvers, separated by commas.
     *
     * @return self
     */
