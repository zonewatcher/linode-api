...
/**
 * LKENodePoolRequestBodyAutoscaler Class Doc Comment
 *
 * @category Class
 * @description When enabled, the number of nodes autoscales within the defined minimum and maximum values.  When making a request, &#x60;max&#x60; and &#x60;min&#x60; require each other.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class LKENodePoolRequestBodyAutoscaler implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKENodePoolRequestBody_autoscaler';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['min']) && ($this->container['min'] > 100)) {
     ...
     * Sets enabled
     *
     * @param bool|null $enabled Whether autoscaling is enabled for this Node Pool. Defaults to `false`.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param int|null $max The maximum number of nodes to autoscale to. Defaults to the Node Pool's `count`. Defaults to the value provided by the `count` field.
     *
     * @return self
     */
    public function setMax($max)
    {
        ...
        if (!is_null($max) && ($max > 100)) {
            throw new \InvalidArgumentException('invalid value for $max when calling LKENodePoolRequestBodyAutoscaler., must be smaller than or equal to 100.');
        }
        if (!is_null($max) && ($max < 1)) {
            throw new \InvalidArgumentException('invalid value for $max when calling LKENodePoolRequestBodyAutoscaler., must be bigger than or equal to 1.');
        }
     ...
     * Sets min
     *
     * @param int|null $min The minimum number of nodes to autoscale to. Defaults to the Node Pool's `count`.
     *
     * @return self
     */
    public function setMin($min)
    {
        ...
        if (!is_null($min) && ($min > 100)) {
            throw new \InvalidArgumentException('invalid value for $min when calling LKENodePoolRequestBodyAutoscaler., must be smaller than or equal to 100.');
        }
        if (!is_null($min) && ($min < 1)) {
            throw new \InvalidArgumentException('invalid value for $min when calling LKENodePoolRequestBodyAutoscaler., must be bigger than or equal to 1.');
        }
