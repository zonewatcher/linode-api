...
/**
 * LinodeStatsIo Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeStatsIo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeStats_io';
     ...
     * Sets io
     *
     * @param float[][]|null $io Block/s written.
     *
     * @return self
     */
     ...
     * Sets swap
     *
     * @param float[][]|null $swap Block/s written.
     *
     * @return self
     */
