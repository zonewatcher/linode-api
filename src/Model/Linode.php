 ...
 */
class Linode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Linode';
    ...
    protected static $openAPITypes = [
        ...
        'ipv4' => 'string[]',
        'ipv6' => 'string',
        'specs' => '\ZoneWatcher\LinodeApiV4\Model\LinodeSpecs',
        'alerts' => '\ZoneWatcher\LinodeApiV4\Model\LinodeAlerts',
        'backups' => '\ZoneWatcher\LinodeApiV4\Model\LinodeBackups',
    ...
    protected static $setters = [
        ...
        'alerts' => 'setAlerts',
        'backups' => 'setBackups',
        'watchdog_enabled' => 'setWatchdogEnabled'
    ];
    ...
    protected static $getters = [
        ...
        'alerts' => 'getAlerts',
        'backups' => 'getBackups',
        'watchdog_enabled' => 'getWatchdogEnabled'
    ];
     ...
     * @return string[]
     */
    public function getHypervisorAllowableValues()
    {
        return [
            self::HYPERVISOR_KVM,
        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['watchdog_enabled'] = $data['watchdog_enabled'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label']) && (mb_strlen($this->container['label']) > 32)) {
        ...
        if (!is_null($this->container['label']) && !preg_match("/^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/", $this->container['label'])) {
            $invalidProperties[] = "invalid value for 'label', must be conform to the pattern /^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/.";
        }
        ...
        $allowedValues = $this->getHypervisorAllowableValues();
        if (!is_null($this->container['hypervisor']) && !in_array($this->container['hypervisor'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'hypervisor', must be one of '%s'",
                $this->container['hypervisor'],
                implode("', '", $allowedValues)
            );
        }
     ...
     * Sets label
     *
     * @param string|null $label The Linode's label is for display purposes only. If no label is provided for a Linode, a default will be assigned.  Linode labels have the following constraints:    * Must begin and end with an alphanumeric character.   * May only consist of alphanumeric characters, dashes (`-`), underscores (`_`) or periods (`.`).   * Cannot have two dashes (`--`), underscores (`__`) or periods (`..`) in a row.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Linode., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Linode., must be bigger than or equal to 3.');
        }
        if (!is_null($label) && (!preg_match("/^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling Linode., must conform to the pattern /^[a-zA-Z]((?!--|__|..)[a-zA-Z0-9-_.])+$/.");
        }
     ...
     * Sets region
     *
     * @param string|null $region This is the [Region](/docs/api/regions/#regions-list) where the Linode was deployed. A Linode's region can only be changed by initiating a [cross data center migration](/docs/api/linode-instances/#dc-migrationpending-host-migration-initiate).
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type This is the [Linode Type](/docs/api/linode-types/#types-list) that this Linode was deployed with. To change a Linode's Type, use [POST /linode/instances/{linodeId}/resize](/docs/api/linode-instances/#linode-resize).
     *
     * @return self
     */
     ...
     * Sets group
     *
     * @param string|null $group A deprecated property denoting a group label for this Linode.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets id
     *
     * @param int|null $id This Linode's ID which must be provided for all operations impacting this Linode.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status A brief description of this Linode's current state. This field may change without direct action from you. For example, when a Linode goes into maintenance mode its status will display \"stopped\".
     *
     * @return self
     */
     ...
     * Sets hypervisor
     *
     * @param string|null $hypervisor The virtualization software powering this Linode.
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getHypervisorAllowableValues();
        if (!is_null($hypervisor) && !in_array($hypervisor, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'hypervisor', must be one of '%s'",
                    $hypervisor,
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Linode was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated When this Linode was last updated.
     *
     * @return self
     */
     ...
     * Sets ipv6
     *
     * @param string|null $ipv6 This Linode's IPv6 SLAAC address. This address is specific to a Linode, and may not be shared. If the Linode has not been assigned an IPv6 address, the return value will be `null`.
     *
     * @return self
     */
     ...
     * Gets specs
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeSpecs|null
     */
     ...
     * Sets specs
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeSpecs|null $specs specs
     *
     * @return self
     */
     ...
     * Gets alerts
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeAlerts|null
     */
     ...
     * Sets alerts
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeAlerts|null $alerts alerts
     *
     * @return self
     */
     ...
     * Gets backups
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeBackups|null
     */
     ...
     * Sets backups
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeBackups|null $backups backups
     *
     * @return self
     */
    ...
    /**
     * Gets watchdog_enabled
     *
     * @return bool|null
     */
    public function getWatchdogEnabled()
    {
        return $this->container['watchdog_enabled'];
    }

    /**
     * Sets watchdog_enabled
     *
     * @param bool|null $watchdog_enabled The watchdog, named Lassie, is a Shutdown Watchdog that monitors your Linode and will reboot it if it powers off unexpectedly. It works by issuing a boot job when your Linode powers off without a shutdown job being responsible. To prevent a loop, Lassie will give up if there have been more than 5 boot jobs issued within 15 minutes.
     *
     * @return self
     */
    public function setWatchdogEnabled($watchdog_enabled)
    {
        $this->container['watchdog_enabled'] = $watchdog_enabled;
