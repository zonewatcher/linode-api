...
class Transfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets billable
     *
     * @param int|null $billable The amount of your transfer pool that is billable this billing cycle.
     *
     * @return self
     */
     ...
     * Sets quota
     *
     * @param int|null $quota The amount of network usage allowed this billing cycle.
     *
     * @return self
     */
     ...
     * Sets used
     *
     * @param int|null $used The amount of network usage you have used this billing cycle.
     *
     * @return self
     */
