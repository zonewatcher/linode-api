...
class PayPal implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets usd
     *
     * @param string $usd The payment amount in USD. Minimum accepted value of $5 USD. Maximum accepted value of $500 USD or credit card payment limit; whichever value is highest. PayPal's maximum transaction limit is $10,000 USD.
     *
     * @return self
     */
