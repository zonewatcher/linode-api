...
class InlineObject10 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'allow_auto_disk_resize' => 'setAllowAutoDiskResize'
    ];
    ...
    protected static $getters = [
        'allow_auto_disk_resize' => 'getAllowAutoDiskResize'
    ];
    ...
    {
        $this->container['allow_auto_disk_resize'] = $data['allow_auto_disk_resize'] ?? true;
    }
    ...
    /**
     * Gets allow_auto_disk_resize
     *
     * @return bool|null
     */
    public function getAllowAutoDiskResize()
    {
        return $this->container['allow_auto_disk_resize'];
    }

    /**
     * Sets allow_auto_disk_resize
     *
     * @param bool|null $allow_auto_disk_resize Automatically resize disks when resizing a Linode. When resizing down to a smaller plan your Linode's data must fit within the smaller disk size.
     *
     * @return self
     */
    public function setAllowAutoDiskResize($allow_auto_disk_resize)
    {
        $this->container['allow_auto_disk_resize'] = $allow_auto_disk_resize;
