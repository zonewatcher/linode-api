...
/**
 * PaginationEnvelope Class Doc Comment
 *
 * @category Class
 * @description An envelope for paginated response. When accessing a collection through a GET endpoint, the results are wrapped in this envelope which includes metadata about those results. Results are presented within a &#x60;data&#x60; array. See [Pagination](/docs/api/#pagination) for more information.
 * @package  ZoneWatcher\LinodeApiV4
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PaginationEnvelope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginationEnvelope';
     ...
     * Sets pages
     *
     * @param int|null $pages The total number of [pages](/docs/api/#pagination).
     *
     * @return self
     */
     ...
     * Sets page
     *
     * @param int|null $page The current [page](/docs/api/#pagination).
     *
     * @return self
     */
     ...
     * Sets results
     *
     * @param int|null $results The total number of results.
     *
     * @return self
     */
