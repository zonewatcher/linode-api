 ...
 */
class UserDefinedField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDefinedField';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['one_of'] = $data['one_of'] ?? null;
        $this->container['many_of'] = $data['many_of'] ?? null;
     ...
     * Sets label
     *
     * @param string $label A human-readable label for the field that will serve as the input prompt for entering the value during deployment.
     *
     * @return self
     */
     ...
     * Sets example
     *
     * @param string $example An example value for the field.
     *
     * @return self
     */
     ...
     * Sets one_of
     *
     * @param string|null $one_of A list of acceptable single values for the field.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getManyOf()
    {
        return $this->container['many_of'];
    }

    /**
     * Sets many_of
     *
     * @param string|null $many_of A list of acceptable values for the field in any quantity, combination or order.
     *
     * @return self
     */
    public function setManyOf($many_of)
    {
        $this->container['many_of'] = $many_of;
     ...
     * Sets default
     *
     * @param string|null $default The default value.  If not specified, this value will be used.
     *
     * @return self
     */
