...
class Region implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'capabilities' => 'string[]',
        'status' => 'string',
        'resolvers' => '\ZoneWatcher\LinodeApiV4\Model\RegionResolvers'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['resolvers'] = $data['resolvers'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id The unique ID of this Region.
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country The country where this Region resides.
     *
     * @return self
     */
     ...
     * Sets capabilities
     *
     * @param string[]|null $capabilities A list of capabilities of this region.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status This region's current operational status.
     *
     * @return self
     */
     ...
     * Gets resolvers
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\RegionResolvers|null
     */
    public function getResolvers()
    {
        return $this->container['resolvers'];
    }

    /**
     * Sets resolvers
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\RegionResolvers|null $resolvers resolvers
     *
     * @return self
     */
    public function setResolvers($resolvers)
    {
        $this->container['resolvers'] = $resolvers;
