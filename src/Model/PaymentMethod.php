...
class PaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'is_default' => 'bool',
        'created' => '\DateTime',
        'data' => '\ZoneWatcher\LinodeApiV4\Model\PaymentMethodData'
    ];
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this Payment Method.
     *
     * @return self
     */
     ...
     * Sets is_default
     *
     * @param bool|null $is_default Whether this Payment Method is the default method for automatically processing service charges.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When the Payment Method was added to the Account.
     *
     * @return self
     */
     ...
     * Gets data
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\PaymentMethodData|null
     */
     ...
     * Sets data
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\PaymentMethodData|null $data data
     *
     * @return self
     */
