...
/**
 * FirewallRuleConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class FirewallRuleConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FirewallRuleConfig';
    ...
    protected static $openAPITypes = [
        'protocol' => 'string',
        'ports' => 'string',
        'addresses' => '\ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfigAddresses',
        'action' => 'string',
        'label' => 'string',
        'description' => 'string'
    ];
     ...
     * Sets protocol
     *
     * @param string|null $protocol The type of network traffic to allow.
     *
     * @return self
     */
     ...
     * Gets addresses
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfigAddresses|null
     */
     ...
     * Sets addresses
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\FirewallRuleConfigAddresses|null $addresses addresses
     *
     * @return self
     */
     ...
     * Sets action
     *
     * @param string|null $action Controls whether traffic is accepted or dropped by this rule. Overrides the Firewall's `inbound_policy` if this is an inbound rule, or the `outbound_policy` if this is an outbound rule.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Used to identify this rule. For display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 32)) {
            throw new \InvalidArgumentException('invalid length for $label when calling FirewallRuleConfig., must be smaller than or equal to 32.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling FirewallRuleConfig., must be bigger than or equal to 3.');
        }
     ...
     * Sets description
     *
     * @param string|null $description Used to describe this rule. For display purposes only.
     *
     * @return self
     */
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new \InvalidArgumentException('invalid length for $description when calling FirewallRuleConfig., must be smaller than or equal to 100.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling FirewallRuleConfig., must be bigger than or equal to 1.');
        }
