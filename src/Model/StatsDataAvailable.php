...
/**
 * StatsDataAvailable Class Doc Comment
 *
 * @category Class
 ...
 */
class StatsDataAvailable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StatsDataAvailable';
    ...
    protected static $openAPITypes = [
        'cpu' => '\ZoneWatcher\LinodeApiV4\Model\StatsData[]',
        'disk' => '\ZoneWatcher\LinodeApiV4\Model\StatsData[]',
        'swap' => '\ZoneWatcher\LinodeApiV4\Model\StatsData[]',
        'net_in' => '\ZoneWatcher\LinodeApiV4\Model\StatsData[]',
        'net_out' => '\ZoneWatcher\LinodeApiV4\Model\StatsData[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['net_in'] = $data['net_in'] ?? null;
        $this->container['net_out'] = $data['net_out'] ?? null;
    }
     ...
     * Gets cpu
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null
     */
     ...
     * Sets cpu
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null $cpu CPU usage stats from the last 24 hours.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null $disk Disk usage stats from the last 24 hours.
     *
     * @return self
     */
     ...
     * Sets swap
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null $swap Swap usage stats from the last 24 hours.
     *
     * @return self
     */
     ...
     * Sets net_in
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null $net_in Inbound network traffic stats from the last 24 hours.
     *
     * @return self
     */
     ...
     * Sets net_out
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\StatsData[]|null $net_out Outbound network traffic stats from the last 24 hours.
     *
     * @return self
     */
