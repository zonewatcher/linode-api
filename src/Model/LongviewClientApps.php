...
/**
 * LongviewClientApps Class Doc Comment
 *
 * @category Class
 ...
 */
class LongviewClientApps implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LongviewClient_apps';
    ...
    {
        $this->container['apache'] = $data['apache'] ?? null;
        $this->container['nginx'] = $data['nginx'] ?? null;
        $this->container['mysql'] = $data['mysql'] ?? null;
    }
    ...
    {
        return $this->container['apache'];
    }

    /**
     * Sets apache
     *
     * @param bool|null $apache If True, the Apache Longview Client module is monitoring Apache on your server.
     *
     * @return self
     */
    public function setApache($apache)
    {
        $this->container['apache'] = $apache;
     ...
     * Sets nginx
     *
     * @param bool|null $nginx If True, the Nginx Longview Client module is monitoring Nginx on your server.
     *
     * @return self
     */
     ...
     * Sets mysql
     *
     * @param bool|null $mysql If True, the MySQL Longview Client modules is monitoring MySQL on your server.
     *
     * @return self
     */
