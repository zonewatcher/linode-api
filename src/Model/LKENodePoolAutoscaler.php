...
/**
 * LKENodePoolAutoscaler Class Doc Comment
 *
 * @category Class
 ...
 */
class LKENodePoolAutoscaler implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKENodePool_autoscaler';
     ...
     * Sets max
     *
     * @param int|null $max The maximum number of nodes to autoscale to. Defaults to the Node Pool's `count`.
     *
     * @return self
     */
    public function setMax($max)
    {
        ...
        if (!is_null($max) && ($max > 100)) {
            throw new \InvalidArgumentException('invalid value for $max when calling LKENodePoolAutoscaler., must be smaller than or equal to 100.');
        }
        if (!is_null($max) && ($max < 1)) {
            throw new \InvalidArgumentException('invalid value for $max when calling LKENodePoolAutoscaler., must be bigger than or equal to 1.');
        }
    ...
    public function setMin($min)
    {
        ...
        if (!is_null($min) && ($min > 100)) {
            throw new \InvalidArgumentException('invalid value for $min when calling LKENodePoolAutoscaler., must be smaller than or equal to 100.');
        }
        if (!is_null($min) && ($min < 1)) {
            throw new \InvalidArgumentException('invalid value for $min when calling LKENodePoolAutoscaler., must be bigger than or equal to 1.');
        }
