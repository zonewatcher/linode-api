...
class InlineObject7 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets overwrite
     *
     * @param bool|null $overwrite If True, deletes all Disks and Configs on the target Linode before restoring.  If False, and the Disk image size is larger than the available space on the Linode, an error message indicating insufficient space is returned.
     *
     * @return self
     */
