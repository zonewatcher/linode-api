...
/**
 * NodeBalancerTransfer Class Doc Comment
 *
 * @category Class
 ...
 */
class NodeBalancerTransfer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NodeBalancer_transfer';
     ...
     * Sets total
     *
     * @param float|null $total The total transfer, in MB, used by this NodeBalancer this month.
     *
     * @return self
     */
     ...
     * Sets out
     *
     * @param float|null $out The total inbound transfer, in MB, used for this NodeBalancer this month.
     *
     * @return self
     */
     ...
     * Sets in
     *
     * @param float|null $in The total outbound transfer, in MB, used for this NodeBalancer this month.
     *
     * @return self
     */
