...
class InlineObject19 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'persist_across_boots' => 'setPersistAcrossBoots'
    ];
    ...
    protected static $getters = [
        ...
        'persist_across_boots' => 'getPersistAcrossBoots'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['persist_across_boots'] = $data['persist_across_boots'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['linode_id'] === null) {
            $invalidProperties[] = "'linode_id' can't be null";
        }
     ...
     * Sets linode_id
     *
     * @param int $linode_id The ID of the Linode to attach the volume to.
     *
     * @return self
     */
     ...
     * Sets config_id
     *
     * @param int|null $config_id The ID of the Linode Config to include this Volume in. Must belong to the Linode referenced by `linode_id`. If not given, the last booted Config will be chosen.
     *
     * @return self
     */
