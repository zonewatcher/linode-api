...
/**
 * ManagedIssue Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedIssue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedIssue';
    ...
    protected static $openAPITypes = [
        ...
        'created' => '\DateTime',
        'services' => 'int[]',
        'entity' => '\ZoneWatcher\LinodeApiV4\Model\ManagedIssueEntity'
    ];
     ...
     * Sets id
     *
     * @param int|null $id This Issue's unique ID.
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Issue was created. Issues are created in response to issues detected with Managed Services, so this is also when the Issue was detected.
     *
     * @return self
     */
     ...
     * Sets services
     *
     * @param int[]|null $services An array of Managed Service IDs that were affected by this Issue.
     *
     * @return self
     */
     ...
     * Gets entity
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\ManagedIssueEntity|null
     */
     ...
     * Sets entity
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\ManagedIssueEntity|null $entity entity
     *
     * @return self
     */
