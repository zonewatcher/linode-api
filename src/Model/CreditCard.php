...
class CreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['card_number']) > 24)) {
            $invalidProperties[] = "invalid value for 'card_number', the character length must be smaller than or equal to 24.";
        }

        if ((mb_strlen($this->container['card_number']) < 14)) {
            $invalidProperties[] = "invalid value for 'card_number', the character length must be bigger than or equal to 14.";
        }

        if ($this->container['expiry_month'] === null) {
            $invalidProperties[] = "'expiry_month' can't be null";
        }
        if (($this->container['expiry_month'] > 12)) {
            $invalidProperties[] = "invalid value for 'expiry_month', must be smaller than or equal to 12.";
        }

        if (($this->container['expiry_month'] < 1)) {
            $invalidProperties[] = "invalid value for 'expiry_month', must be bigger than or equal to 1.";
        }
    ...
    {
        if ((mb_strlen($card_number) > 24)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling CreditCard., must be smaller than or equal to 24.');
        }
        if ((mb_strlen($card_number) < 14)) {
            throw new \InvalidArgumentException('invalid length for $card_number when calling CreditCard., must be bigger than or equal to 14.');
        }
     ...
     * Sets expiry_month
     *
     * @param int $expiry_month A value from 1-12 representing the expiration month of your credit card.    * 1 = January   * 2 = February   * 3 = March   * Etc.
     *
     * @return self
     */
    public function setExpiryMonth($expiry_month)
    {
        ...
        if (($expiry_month > 12)) {
            throw new \InvalidArgumentException('invalid value for $expiry_month when calling CreditCard., must be smaller than or equal to 12.');
        }
        if (($expiry_month < 1)) {
            throw new \InvalidArgumentException('invalid value for $expiry_month when calling CreditCard., must be bigger than or equal to 1.');
        }
     ...
     * Sets expiry_year
     *
     * @param int $expiry_year A four-digit integer representing the expiration year of your credit card.  The combination of `expiry_month` and `expiry_year` must result in a month/year combination of the current month or in the future. An expiration date set in the past is invalid.
     *
     * @return self
     */
     ...
     * Sets cvv
     *
     * @param string $cvv CVV (Card Verification Value) of the credit card, typically found on the back of the card.
     *
     * @return self
     */
    public function setCvv($cvv)
    {
        ...
        if ((mb_strlen($cvv) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cvv when calling CreditCard., must be bigger than or equal to 3.');
        }
