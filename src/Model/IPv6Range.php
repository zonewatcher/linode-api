 ...
 */
class IPv6Range implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPv6Range';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['route_target'] = $data['route_target'] ?? null;
    }
     ...
     * Sets range
     *
     * @param string|null $range The IPv6 range of addresses in this pool.
     *
     * @return self
     */
     ...
     * Sets prefix
     *
     * @param int|null $prefix The prefix length of the address, denoting how many addresses can be assigned from this range calculated as 2 <sup>128-prefix</sup>.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region for this range of IPv6 addresses.
     *
     * @return self
     */
    ...
    {
        return $this->container['route_target'];
    }

    /**
     * Sets route_target
     *
     * @param string|null $route_target The last address in this block of IPv6 addresses.
     *
     * @return self
     */
    public function setRouteTarget($route_target)
    {
        $this->container['route_target'] = $route_target;
