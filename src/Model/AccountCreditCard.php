...
/**
 * AccountCreditCard Class Doc Comment
 *
 * @category Class
 ...
 */
class AccountCreditCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Account_credit_card';
     ...
     * Sets last_four
     *
     * @param string|null $last_four The last four digits of the credit card associated with this Account.
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param string|null $expiry The expiration month and year of the credit card.
     *
     * @return self
     */
