 ...
 */
class StackScript implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StackScript';
    ...
    protected static $openAPITypes = [
        ...
        'rev_note' => 'string',
        'script' => 'string',
        'user_defined_fields' => '\ZoneWatcher\LinodeApiV4\Model\UserDefinedField[]',
        'mine' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'description' => null,
        'images' => null,
        'deployments_total' => null,
        'deployments_active' => null,
        'is_public' => null,
        'created' => 'date-time',
        'updated' => 'date-time',
        'rev_note' => null,
    ...
    protected static $setters = [
        ...
        'user_gravatar_id' => 'setUserGravatarId',
        'label' => 'setLabel',
        'description' => 'setDescription',
        'images' => 'setImages',
        'deployments_total' => 'setDeploymentsTotal',
        'deployments_active' => 'setDeploymentsActive',
        'is_public' => 'setIsPublic',
        'created' => 'setCreated',
        'updated' => 'setUpdated',
        'rev_note' => 'setRevNote',
        'script' => 'setScript',
        'user_defined_fields' => 'setUserDefinedFields',
        'mine' => 'setMine'
    ];
    ...
    protected static $getters = [
        ...
        'user_gravatar_id' => 'getUserGravatarId',
        'label' => 'getLabel',
        'description' => 'getDescription',
        'images' => 'getImages',
        'deployments_total' => 'getDeploymentsTotal',
        'deployments_active' => 'getDeploymentsActive',
        'is_public' => 'getIsPublic',
        'created' => 'getCreated',
        'updated' => 'getUpdated',
        'rev_note' => 'getRevNote',
        'script' => 'getScript',
        'user_defined_fields' => 'getUserDefinedFields',
        'mine' => 'getMine'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['user_gravatar_id'] = $data['user_gravatar_id'] ?? null;
        $this->container['label'] = $data['label'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['images'] = $data['images'] ?? null;
        $this->container['deployments_total'] = $data['deployments_total'] ?? null;
        $this->container['deployments_active'] = $data['deployments_active'] ?? null;
        $this->container['is_public'] = $data['is_public'] ?? null;
        $this->container['created'] = $data['created'] ?? null;
        $this->container['updated'] = $data['updated'] ?? null;
        $this->container['rev_note'] = $data['rev_note'] ?? null;
        $this->container['script'] = $data['script'] ?? null;
        $this->container['user_defined_fields'] = $data['user_defined_fields'] ?? null;
        $this->container['mine'] = $data['mine'] ?? null;
    }
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of this StackScript.
     *
     * @return self
     */
     ...
     * Sets username
     *
     * @param string|null $username The User who created the StackScript.
     *
     * @return self
     */
    ...
    /**
     * Gets user_gravatar_id
     *
     * @return string|null
     */
    public function getUserGravatarId()
    {
        return $this->container['user_gravatar_id'];
    }

    /**
     * Sets user_gravatar_id
     *
     * @param string|null $user_gravatar_id The Gravatar ID for the User who created the StackScript.
     *
     * @return self
     */
    public function setUserGravatarId($user_gravatar_id)
    {
        $this->container['user_gravatar_id'] = $user_gravatar_id;
     ...
     * Sets label
     *
     * @param string|null $label The StackScript's label is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 128)) {
            throw new \InvalidArgumentException('invalid length for $label when calling StackScript., must be smaller than or equal to 128.');
        }
        if (!is_null($label) && (mb_strlen($label) < 3)) {
            throw new \InvalidArgumentException('invalid length for $label when calling StackScript., must be bigger than or equal to 3.');
        }
     ...
     * Sets description
     *
     * @param string|null $description A description for the StackScript.
     *
     * @return self
     */
     ...
     * Sets images
     *
     * @param string[]|null $images An array of Image IDs. These are the images that can be deployed with this Stackscript.
     *
     * @return self
     */
    ...
    /**
     * Gets deployments_total
     *
     * @return int|null
     */
    public function getDeploymentsTotal()
    {
        return $this->container['deployments_total'];
    }

    /**
     * Sets deployments_total
     *
     * @param int|null $deployments_total The total number of times this StackScript has been deployed.
     *
     * @return self
     */
    public function setDeploymentsTotal($deployments_total)
    {
        $this->container['deployments_total'] = $deployments_total;

        return $this;
    }

    /**
     * Gets deployments_active
     *
     * @return int|null
     */
    public function getDeploymentsActive()
    {
        return $this->container['deployments_active'];
    }

    /**
     * Sets deployments_active
     *
     * @param int|null $deployments_active Count of currently active, deployed Linodes created from this StackScript.
     *
     * @return self
     */
    public function setDeploymentsActive($deployments_active)
    {
        $this->container['deployments_active'] = $deployments_active;
     ...
     * Sets is_public
     *
     * @param bool|null $is_public This determines whether other users can use your StackScript. **Once a StackScript is made public, it cannot be made private.**
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date this StackScript was created.
     *
     * @return self
     */
     ...
     * Sets updated
     *
     * @param \DateTime|null $updated The date this StackScript was last updated.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getRevNote()
    {
        return $this->container['rev_note'];
    }

    /**
     * Sets rev_note
     *
     * @param string|null $rev_note This field allows you to add notes for the set of revisions made to this StackScript.
     *
     * @return self
     */
    public function setRevNote($rev_note)
    {
        $this->container['rev_note'] = $rev_note;
     ...
     * Sets script
     *
     * @param string|null $script The script to execute when provisioning a new Linode with this StackScript.
     *
     * @return self
     */
     ...
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\UserDefinedField[]|null
     */
    public function getUserDefinedFields()
    {
        return $this->container['user_defined_fields'];
    }

    /**
     * Sets user_defined_fields
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\UserDefinedField[]|null $user_defined_fields This is a list of fields defined with a special syntax inside this StackScript that allow for supplying customized parameters during deployment. See <a target=\"_top\" href=\"/docs/platform/stackscripts/#variables-and-udfs\">Variables and UDFs</a> for more information.
     *
     * @return self
     */
    public function setUserDefinedFields($user_defined_fields)
    {
        $this->container['user_defined_fields'] = $user_defined_fields;
    ...
    {
        return $this->container['mine'];
    }

    /**
     * Sets mine
     *
     * @param bool|null $mine Returns `true` if this StackScript is owned by the account of the user making the request, and the user making the request is unrestricted or has access to this StackScript.
     *
     * @return self
     */
    public function setMine($mine)
    {
        $this->container['mine'] = $mine;
