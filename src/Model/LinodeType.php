 ...
 */
class LinodeType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeType';
    ...
    protected static $openAPITypes = [
        ...
        'disk' => 'int',
        'class' => 'string',
        'price' => '\ZoneWatcher\LinodeApiV4\Model\LinodeTypePrice',
        'addons' => '\ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddons',
        'network_out' => 'int',
        'memory' => 'int',
        'successor' => 'string',
        'transfer' => 'int',
    ...
    const MODEL_CLASS_NANODE = 'nanode';
    const MODEL_CLASS_STANDARD = 'standard';
    const MODEL_CLASS_DEDICATED = 'dedicated';
    const MODEL_CLASS_GPU = 'gpu';
    const MODEL_CLASS_HIGHMEM = 'highmem';
    ...
    {
        return [
            self::MODEL_CLASS_NANODE,
            self::MODEL_CLASS_STANDARD,
            self::MODEL_CLASS_DEDICATED,
            self::MODEL_CLASS_GPU,
            self::MODEL_CLASS_HIGHMEM,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['vcpus'] = $data['vcpus'] ?? null;
        $this->container['gpus'] = $data['gpus'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id The ID representing the Linode Type.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The Linode Type's label is for display purposes only.
     *
     * @return self
     */
     ...
     * Sets disk
     *
     * @param int|null $disk The Disk size, in MB, of the Linode Type.
     *
     * @return self
     */
     ...
     * Gets price
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeTypePrice|null
     */
     ...
     * Sets price
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeTypePrice|null $price price
     *
     * @return self
     */
     ...
     * Gets addons
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddons|null
     */
     ...
     * Sets addons
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LinodeTypeAddons|null $addons addons
     *
     * @return self
     */
     ...
     * Sets network_out
     *
     * @param int|null $network_out The Mbits outbound bandwidth allocation.
     *
     * @return self
     */
     ...
     * Sets memory
     *
     * @param int|null $memory Amount of RAM included in this Linode Type.
     *
     * @return self
     */
     ...
     * Sets successor
     *
     * @param string|null $successor The Linode Type that a [mutate](/docs/api/linode-instances/#linode-upgrade) will upgrade to for a Linode of this type.  If \"null\", a Linode of this type may not mutate.
     *
     * @return self
     */
     ...
     * Sets transfer
     *
     * @param int|null $transfer The monthly outbound transfer amount, in MB.
     *
     * @return self
     */
     ...
     * Sets vcpus
     *
     * @param int|null $vcpus The number of VCPU cores this Linode Type offers.
     *
     * @return self
     */
     ...
     * Sets gpus
     *
     * @param int|null $gpus The number of GPUs this Linode Type offers.
     *
     * @return self
     */
