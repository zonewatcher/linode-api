...
class Payment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int|null $id The unique ID of the Payment.
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime|null $date When the Payment was made.
     *
     * @return self
     */
     ...
     * Sets usd
     *
     * @param int|null $usd The amount, in US dollars, of the Payment.
     *
     * @return self
     */
