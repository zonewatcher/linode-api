...
class Promotion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'credit_monthly_cap' => null,
        'credit_remaining' => null,
        'description' => null,
        'expire_dt' => null,
        'image_url' => null,
        'summary' => null,
        'this_month_credit_remaining' => null,
        'service_type' => null
    ];
    ...
    protected static $setters = [
        'credit_monthly_cap' => 'setCreditMonthlyCap',
        'credit_remaining' => 'setCreditRemaining',
        'description' => 'setDescription',
        'expire_dt' => 'setExpireDt',
        'image_url' => 'setImageUrl',
        'summary' => 'setSummary',
        'this_month_credit_remaining' => 'setThisMonthCreditRemaining',
    ...
    protected static $getters = [
        'credit_monthly_cap' => 'getCreditMonthlyCap',
        'credit_remaining' => 'getCreditRemaining',
        'description' => 'getDescription',
        'expire_dt' => 'getExpireDt',
        'image_url' => 'getImageUrl',
        'summary' => 'getSummary',
        'this_month_credit_remaining' => 'getThisMonthCreditRemaining',
    ...
    const SERVICE_TYPE_BACKUP = 'backup';
    const SERVICE_TYPE_BLOCKSTORAGE = 'blockstorage';
    const SERVICE_TYPE_DB_MYSQL = 'db_mysql';
    const SERVICE_TYPE_IP_V4 = 'ip_v4';
    const SERVICE_TYPE_LINODE = 'linode';
    const SERVICE_TYPE_LINODE_DISK = 'linode_disk';
    const SERVICE_TYPE_LINODE_MEMORY = 'linode_memory';
    const SERVICE_TYPE_LONGVIEW = 'longview';
    const SERVICE_TYPE_MANAGED = 'managed';
    const SERVICE_TYPE_NODEBALANCER = 'nodebalancer';
    const SERVICE_TYPE_OBJECTSTORAGE = 'objectstorage';
    const SERVICE_TYPE_TRANSFER_TX = 'transfer_tx';
    ...
    public function getServiceTypeAllowableValues()
    {
        return [
            ...
            self::SERVICE_TYPE_BACKUP,
            self::SERVICE_TYPE_BLOCKSTORAGE,
            self::SERVICE_TYPE_DB_MYSQL,
            self::SERVICE_TYPE_IP_V4,
            self::SERVICE_TYPE_LINODE,
            self::SERVICE_TYPE_LINODE_DISK,
            self::SERVICE_TYPE_LINODE_MEMORY,
            self::SERVICE_TYPE_LONGVIEW,
            self::SERVICE_TYPE_MANAGED,
            self::SERVICE_TYPE_NODEBALANCER,
            self::SERVICE_TYPE_OBJECTSTORAGE,
            self::SERVICE_TYPE_TRANSFER_TX,
        ];
    }
    ...
    {
        $this->container['credit_monthly_cap'] = $data['credit_monthly_cap'] ?? null;
        $this->container['credit_remaining'] = $data['credit_remaining'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['expire_dt'] = $data['expire_dt'] ?? null;
        $this->container['image_url'] = $data['image_url'] ?? null;
        $this->container['summary'] = $data['summary'] ?? null;
        $this->container['this_month_credit_remaining'] = $data['this_month_credit_remaining'] ?? null;
    ...
    /**
     * Gets credit_monthly_cap
     *
     * @return string|null
     */
    public function getCreditMonthlyCap()
    {
        return $this->container['credit_monthly_cap'];
    }

    /**
     * Sets credit_monthly_cap
     *
     * @param string|null $credit_monthly_cap The amount available to spend per month.
     *
     * @return self
     */
    public function setCreditMonthlyCap($credit_monthly_cap)
    {
        $this->container['credit_monthly_cap'] = $credit_monthly_cap;
     ...
     *
     * @param string|null $credit_remaining The total amount of credit left for this promotion.
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description A detailed description of this promotion.
     *
     * @return self
     */
     ...
     * Sets expire_dt
     *
     * @param string|null $expire_dt When this promotion's credits expire.
     *
     * @return self
     */
     ...
     * Sets image_url
     *
     * @param string|null $image_url The location of an image for this promotion.
     *
     * @return self
     */
     ...
     * Sets summary
     *
     * @param string|null $summary Short details of this promotion.
     *
     * @return self
     */
    ...
    /**
     * Gets this_month_credit_remaining
     *
     * @return string|null
     */
    public function getThisMonthCreditRemaining()
    {
        return $this->container['this_month_credit_remaining'];
    }

    /**
     * Sets this_month_credit_remaining
     *
     * @param string|null $this_month_credit_remaining The amount of credit left for this month for this promotion.
     *
     * @return self
     */
    public function setThisMonthCreditRemaining($this_month_credit_remaining)
    {
        $this->container['this_month_credit_remaining'] = $this_month_credit_remaining;
     ...
     * Sets service_type
     *
     * @param string|null $service_type The service to which this promotion applies.
     *
     * @return self
     */
