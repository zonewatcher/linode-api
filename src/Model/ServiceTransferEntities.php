...
/**
 * ServiceTransferEntities Class Doc Comment
 *
 * @category Class
 ...
 */
class ServiceTransferEntities implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceTransfer_entities';
     ...
     * Sets linodes
     *
     * @param int[]|null $linodes An array containing the IDs of each of the Linodes included in this transfer.
     *
     * @return self
     */
