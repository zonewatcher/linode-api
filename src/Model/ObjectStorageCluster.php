...
/**
 * ObjectStorageCluster Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectStorageCluster implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageCluster';
    ...
    protected static $setters = [
        ...
        'status' => 'setStatus',
        'region' => 'setRegion',
        'static_site_domain' => 'setStaticSiteDomain'
    ];
    ...
    protected static $getters = [
        ...
        'status' => 'getStatus',
        'region' => 'getRegion',
        'static_site_domain' => 'getStaticSiteDomain'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['static_site_domain'] = $data['static_site_domain'] ?? null;
    }
     ...
     * Sets id
     *
     * @param string|null $id The unique ID for this cluster.
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain The base URL for this cluster, used for connecting with third-party clients.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status This cluster's status.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region The region where this cluster is located.
     *
     * @return self
     */
    ...
    /**
     * Gets static_site_domain
     *
     * @return string|null
     */
    public function getStaticSiteDomain()
    {
        return $this->container['static_site_domain'];
    }

    /**
     * Sets static_site_domain
     *
     * @param string|null $static_site_domain The base URL for this cluster used when hosting static sites.
     *
     * @return self
     */
    public function setStaticSiteDomain($static_site_domain)
    {
        $this->container['static_site_domain'] = $static_site_domain;
