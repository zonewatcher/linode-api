...
/**
 * LinodeStatsNetv4 Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeStatsNetv4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeStats_netv4';
     ...
     * Sets in
     *
     * @param float[][]|null $in Input stats for IPv4, measured in bits/s (bits/second).
     *
     * @return self
     */
     ...
     * Sets out
     *
     * @param float[][]|null $out Output stats for IPv4, measured in bits/s (bits/second).
     *
     * @return self
     */
     ...
     * Sets private_in
     *
     * @param float[][]|null $private_in Private IPv4 input statistics, measured in bits/s (bits/second).
     *
     * @return self
     */
     ...
     * Sets private_out
     *
     * @param float[][]|null $private_out Private IPv4 output statistics, measured in bits/s (bits/second).
     *
     * @return self
     */
