...
class InlineResponse409Errors implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets reason
     *
     * @param string|null $reason A string explaining that the account could not be cancelled because there is an outstanding balance on the account that must be paid first.
     *
     * @return self
     */
