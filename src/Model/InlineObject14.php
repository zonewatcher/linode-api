...
class InlineObject14 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\ZoneWatcher\LinodeApiV4\Model\Status'
    ];
     ...
     * Gets status
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Status|null
     */
     ...
     * Sets status
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Status|null $status status
     *
     * @return self
     */
