...
/**
 * LinodeTypePrice Class Doc Comment
 *
 * @category Class
 ...
 */
class LinodeTypePrice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinodeType_price';
     ...
     * Sets hourly
     *
     * @param int|null $hourly Cost (in US dollars) per hour.
     *
     * @return self
     */
     ...
     * Sets monthly
     *
     * @param int|null $monthly Cost (in US dollars) per month.
     *
     * @return self
     */
