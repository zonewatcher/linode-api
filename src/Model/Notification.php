...
class Notification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'entity' => '\ZoneWatcher\LinodeApiV4\Model\NotificationEntity',
        'label' => 'string',
        'message' => 'string',
        'body' => 'string',
        'type' => 'string',
    ...
    const TYPE_MIGRATION_SCHEDULED = 'migration_scheduled';
    const TYPE_MIGRATION_IMMINENT = 'migration_imminent';
    const TYPE_MIGRATION_PENDING = 'migration_pending';
    const TYPE_REBOOT_SCHEDULED = 'reboot_scheduled';
    const TYPE_OUTAGE = 'outage';
    const TYPE_PAYMENT_DUE = 'payment_due';
    const TYPE_TICKET_IMPORTANT = 'ticket_important';
    const TYPE_TICKET_ABUSE = 'ticket_abuse';
    ...
    {
        return [
            self::TYPE_MIGRATION_SCHEDULED,
            self::TYPE_MIGRATION_IMMINENT,
            self::TYPE_MIGRATION_PENDING,
            self::TYPE_REBOOT_SCHEDULED,
            self::TYPE_OUTAGE,
            self::TYPE_PAYMENT_DUE,
            self::TYPE_TICKET_IMPORTANT,
            self::TYPE_TICKET_ABUSE,
            self::TYPE_NOTICE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['when'] = $data['when'] ?? null;
     ...
     * Gets entity
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\NotificationEntity|null
     */
     ...
     * Sets entity
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\NotificationEntity|null $entity entity
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label A short description of this Notification.
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message A human-readable description of the Notification.
     *
     * @return self
     */
     ...
     * Sets body
     *
     * @param string|null $body A full description of this Notification, in markdown format.  Not all Notifications include bodies.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of Notification this is.
     *
     * @return self
     */
     ...
     * Sets severity
     *
     * @param string|null $severity The severity of this Notification.  This field can be used to decide how prominently to display the Notification, what color to make the display text, etc.
     *
     * @return self
     */
     ...
     * Sets until
     *
     * @param \DateTime|null $until If this Notification has a duration, this will be the ending time for the Event/action. For example, if there is scheduled maintenance for one of our systems, `until` would be set to the end of the maintenance window.
     *
     * @return self
     */
