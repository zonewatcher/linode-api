...
class Maintenance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Maintenance';
    ...
    protected static $openAPITypes = [
        ...
        'reason' => 'string',
        'when' => '\DateTime',
        'entity' => '\ZoneWatcher\LinodeApiV4\Model\MaintenanceEntity'
    ];
    ...
    const TYPE_COLD_MIGRATION = 'cold_migration';
    const TYPE_LIVE_MIGRATION = 'live_migration';
    ...
    public function getTypeAllowableValues()
    {
        return [
            self::TYPE_REBOOT,
            self::TYPE_COLD_MIGRATION,
            self::TYPE_LIVE_MIGRATION,
        ];
    }
     ...
     * Sets type
     *
     * @param string|null $type The type of maintenance.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status The maintenance status.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string|null $reason The reason maintenance is being performed.
     *
     * @return self
     */
     ...
     * Gets entity
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\MaintenanceEntity|null
     */
     ...
     * Sets entity
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\MaintenanceEntity|null $entity entity
     *
     * @return self
     */
