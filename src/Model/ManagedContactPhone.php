...
/**
 * ManagedContactPhone Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedContactPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedContact_phone';
     ...
     * Sets primary
     *
     * @param string|null $primary This Contact's primary phone number.
     *
     * @return self
     */
     ...
     * Sets secondary
     *
     * @param string|null $secondary This Contact's secondary phone number.
     *
     * @return self
     */
