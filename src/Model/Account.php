...
class Account implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'active_promotions' => '\ZoneWatcher\LinodeApiV4\Model\Promotion[]',
        ...
        'capabilities' => 'string[]',
        'city' => 'string',
        'credit_card' => '\ZoneWatcher\LinodeApiV4\Model\AccountCreditCard',
        'company' => 'string',
        'country' => 'string',
        'email' => 'string',
        'first_name' => 'string',
    ...
    protected static $openAPIFormats = [
        ...
        'active_since' => 'date-time',
        'address_1' => null,
        'address_2' => null,
        'balance' => null,
        'balance_uninvoiced' => null,
        'capabilities' => null,
        'city' => null,
        'credit_card' => null,
        'company' => null,
    ...
    protected static $setters = [
        ...
        'balance' => 'setBalance',
        'balance_uninvoiced' => 'setBalanceUninvoiced',
    ...
    protected static $getters = [
        ...
        'balance' => 'getBalance',
        'balance_uninvoiced' => 'getBalanceUninvoiced',
    ...
    {
        $this->container['active_promotions'] = $data['active_promotions'] ?? null;
        $this->container['active_since'] = $data['active_since'] ?? null;
        $this->container['address_1'] = $data['address_1'] ?? null;
        $this->container['address_2'] = $data['address_2'] ?? null;
        $this->container['balance'] = $data['balance'] ?? null;
        $this->container['balance_uninvoiced'] = $data['balance_uninvoiced'] ?? null;
        ...
        $this->container['euuid'] = $data['euuid'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['address_1']) && (mb_strlen($this->container['address_1']) > 64)) {
            $invalidProperties[] = "invalid value for 'address_1', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['address_2']) && (mb_strlen($this->container['address_2']) > 64)) {
            $invalidProperties[] = "invalid value for 'address_2', the character length must be smaller than or equal to 64.";
        }

        if (!is_null($this->container['city']) && (mb_strlen($this->container['city']) > 24)) {
            $invalidProperties[] = "invalid value for 'city', the character length must be smaller than or equal to 24.";
        }
        ...
        if (!is_null($this->container['state']) && (mb_strlen($this->container['state']) > 24)) {
            $invalidProperties[] = "invalid value for 'state', the character length must be smaller than or equal to 24.";
        }

        if (!is_null($this->container['tax_id']) && (mb_strlen($this->container['tax_id']) > 100)) {
            $invalidProperties[] = "invalid value for 'tax_id', the character length must be smaller than or equal to 100.";
        }
     ...
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Promotion[]|null
     */
     ...
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Promotion[]|null $active_promotions active_promotions
     *
     * @return self
     */
     ...
     * Sets active_since
     *
     * @param \DateTime|null $active_since The datetime of when the account was activated.
     *
     * @return self
     */
     ...
     * Sets address_1
     *
     * @param string|null $address_1 First line of this Account's billing address.
     *
     * @return self
     */
    public function setAddress1($address_1)
    {
        if (!is_null($address_1) && (mb_strlen($address_1) > 64)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling Account., must be smaller than or equal to 64.');
        }
     ...
     * Sets address_2
     *
     * @param string|null $address_2 Second line of this Account's billing address.
     *
     * @return self
     */
    public function setAddress2($address_2)
    {
        if (!is_null($address_2) && (mb_strlen($address_2) > 64)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling Account., must be smaller than or equal to 64.');
        }
     ...
     * Sets balance
     *
     * @param float|null $balance This Account's balance, in US dollars.
     *
     * @return self
     */
    ...
    /**
     * Gets balance_uninvoiced
     *
     * @return float|null
     */
    public function getBalanceUninvoiced()
    {
        return $this->container['balance_uninvoiced'];
    }

    /**
     * Sets balance_uninvoiced
     *
     * @param float|null $balance_uninvoiced This Account's current estimated invoice in US dollars. This is not your final invoice balance. Transfer charges are not included in the estimate.
     *
     * @return self
     */
    public function setBalanceUninvoiced($balance_uninvoiced)
    {
        $this->container['balance_uninvoiced'] = $balance_uninvoiced;
     ...
     * Sets capabilities
     *
     * @param string[]|null $capabilities A list of capabilities your account supports.
     *
     * @return self
     */
     ...
     * Sets city
     *
     * @param string|null $city The city for this Account's billing address.
     *
     * @return self
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 24)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Account., must be smaller than or equal to 24.');
        }
     ...
     * Gets credit_card
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\AccountCreditCard|null
     */
     ...
     * Sets credit_card
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\AccountCreditCard|null $credit_card credit_card
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param string|null $company The company name associated with this Account.
     *
     * @return self
     */
    public function setCompany($company)
    {
        if (!is_null($company) && (mb_strlen($company) > 128)) {
            throw new \InvalidArgumentException('invalid length for $company when calling Account., must be smaller than or equal to 128.');
        }
     ...
     * Sets country
     *
     * @param string|null $country The two-letter country code of this Account's billing address.
     *
     * @return self
     */
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Account., must be bigger than or equal to 2.');
        }
     ...
     * Sets email
     *
     * @param string|null $email The email address of the person associated with this Account.
     *
     * @return self
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (mb_strlen($email) > 128)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Account., must be smaller than or equal to 128.');
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name The first name of the person associated with this Account.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling Account., must be smaller than or equal to 50.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name The last name of the person associated with this Account.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling Account., must be smaller than or equal to 50.');
        }
     ...
     * Sets phone
     *
     * @param string|null $phone The phone number associated with this Account.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 32)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Account., must be smaller than or equal to 32.');
        }
     ...
     * Sets state
     *
     * @param string|null $state If billing address is in the United States, this is the State portion of the Account's billing address. If the address is outside the US, this is the Province associated with the Account's billing address.
     *
     * @return self
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 24)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Account., must be smaller than or equal to 24.');
        }
     ...
     * Sets tax_id
     *
     * @param string|null $tax_id The tax identification number associated with this Account, for tax calculations in some countries. If you do not live in a country that collects tax, this should be `null`.
     *
     * @return self
     */
    public function setTaxId($tax_id)
    {
        if (!is_null($tax_id) && (mb_strlen($tax_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $tax_id when calling Account., must be smaller than or equal to 100.');
        }
    ...
    {
        return $this->container['euuid'];
    }

    /**
     * Sets euuid
     *
     * @param string|null $euuid An external unique identifier for this account.
     *
     * @return self
     */
    public function setEuuid($euuid)
    {
        $this->container['euuid'] = $euuid;
     ...
     * Sets zip
     *
     * @param string|null $zip The zip code of this Account's billing address. The following restrictions apply:  - May only consist of letters, numbers, spaces, and hyphens. - Must not contain more than 9 letter or number characters.
     *
     * @return self
     */
