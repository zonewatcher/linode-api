...
/**
 * ObjectStorageObject Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectStorageObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectStorageObject';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['next_marker'] = $data['next_marker'] ?? null;
        $this->container['is_truncated'] = $data['is_truncated'] ?? null;
    }
     ...
     * Sets name
     *
     * @param string|null $name The name of this object or prefix.
     *
     * @return self
     */
     ...
     * Sets etag
     *
     * @param string|null $etag An MD-5 hash of the object. `null` if this object represents a prefix.
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified The date and time this object was last modified. `null` if this object represents a prefix.
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param string|null $owner The owner of this object, as a UUID. `null` if this object represents a prefix.
     *
     * @return self
     */
     ...
     * Sets size
     *
     * @param int|null $size The size of this object, in bytes. `null` if this object represents a prefix.
     *
     * @return self
     */
     ...
     * Sets next_marker
     *
     * @param string|null $next_marker Returns the value you should pass to the `marker` query parameter to get the next page of objects. If there is no next page, `null` will be returned.
     *
     * @return self
     */
     ...
     * Sets is_truncated
     *
     * @param bool|null $is_truncated Designates if there is another page of bucket objects.
     *
     * @return self
     */
