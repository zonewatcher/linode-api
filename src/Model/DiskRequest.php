...
class DiskRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'size' => 'int',
        'label' => '\ZoneWatcher\LinodeApiV4\Model\Label',
        'filesystem' => '\ZoneWatcher\LinodeApiV4\Model\Filesystem',
        'image' => 'string',
    ...
    protected static $setters = [
        ...
        'authorized_users' => 'setAuthorizedUsers',
        'root_pass' => 'setRootPass',
        'stackscript_id' => 'setStackscriptId',
        'stackscript_data' => 'setStackscriptData'
    ];
    ...
    protected static $getters = [
        ...
        'stackscript_id' => 'getStackscriptId',
        'stackscript_data' => 'getStackscriptData'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['filesystem'] = $data['filesystem'] ?? null;
        $this->container['image'] = $data['image'] ?? null;
        $this->container['authorized_keys'] = $data['authorized_keys'] ?? null;
        $this->container['authorized_users'] = $data['authorized_users'] ?? null;
        $this->container['root_pass'] = $data['root_pass'] ?? null;
        $this->container['stackscript_id'] = $data['stackscript_id'] ?? null;
        $this->container['stackscript_data'] = $data['stackscript_data'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['root_pass']) && (mb_strlen($this->container['root_pass']) > 128)) {
            $invalidProperties[] = "invalid value for 'root_pass', the character length must be smaller than or equal to 128.";
        }

        if (!is_null($this->container['root_pass']) && (mb_strlen($this->container['root_pass']) < 7)) {
            $invalidProperties[] = "invalid value for 'root_pass', the character length must be bigger than or equal to 7.";
        }
     ...
     * Sets size
     *
     * @param int|null $size The size of the Disk in MB.  Images require a minimum size. Access the Image View ([GET /images/{imageID}](/docs/api/images/#image-view)) endpoint to view its size.
     *
     * @return self
     */
     ...
     * Gets label
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Label|null
     */
     ...
     * Sets label
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Label|null $label label
     *
     * @return self
     */
     ...
     * Gets filesystem
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\Filesystem|null
     */
     ...
     * Sets filesystem
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\Filesystem|null $filesystem filesystem
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $authorized_keys A list of public SSH keys that will be automatically appended to the root user's `~/.ssh/authorized_keys` file when deploying from an Image.
     *
     * @return self
     */
    ...
    /**
     * Gets authorized_users
     *
     * @return string[]|null
     */
    public function getAuthorizedUsers()
    {
        return $this->container['authorized_users'];
    }

    /**
     * Sets authorized_users
     *
     * @param string[]|null $authorized_users A list of usernames. If the usernames have associated SSH keys, the keys will be appended to the root users `~/.ssh/authorized_keys` file automatically when deploying from an Image.
     *
     * @return self
     */
    public function setAuthorizedUsers($authorized_users)
    {
        $this->container['authorized_users'] = $authorized_users;
     ...
     * Sets root_pass
     *
     * @param string|null $root_pass This sets the root user's password on a newly-created Linode Disk when deploying from an Image.  * Must meet a password strength score requirement that is calculated internally by the API. If the strength requirement is not met, you will receive a `Password does not meet strength requirement` error.
     *
     * @return self
     */
    public function setRootPass($root_pass)
    {
        if (!is_null($root_pass) && (mb_strlen($root_pass) > 128)) {
            throw new \InvalidArgumentException('invalid length for $root_pass when calling DiskRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($root_pass) && (mb_strlen($root_pass) < 7)) {
            throw new \InvalidArgumentException('invalid length for $root_pass when calling DiskRequest., must be bigger than or equal to 7.');
        }
     ...
     * @return int|null
     */
    public function getStackscriptId()
    {
        return $this->container['stackscript_id'];
    }

    /**
     * Sets stackscript_id
     *
     * @param int|null $stackscript_id A StackScript ID that will cause the referenced StackScript to be run during deployment of this Linode. A compatible `image` is required to use a StackScript. To get a list of available StackScript and their permitted Images see [/stackscripts](/docs/api/stackscripts/#stackscripts-list). This field cannot be used when deploying from a Backup or a Private Image.
     *
     * @return self
     */
    public function setStackscriptId($stackscript_id)
    {
        $this->container['stackscript_id'] = $stackscript_id;

        return $this;
    }

    /**
     * Gets stackscript_data
     *
     * @return object|null
     */
    public function getStackscriptData()
    {
        return $this->container['stackscript_data'];
    }

    /**
     * Sets stackscript_data
     *
     * @param object|null $stackscript_data This field is required only if the StackScript being deployed requires input data from the User for successful completion. See [User Defined Fields (UDFs)](/docs/guides/writing-scripts-for-use-with-linode-stackscripts-a-tutorial/#user-defined-fields-udfs) for more details. This field is required to be valid JSON.
     *
     * @return self
     */
    public function setStackscriptData($stackscript_data)
    {
        $this->container['stackscript_data'] = $stackscript_data;
