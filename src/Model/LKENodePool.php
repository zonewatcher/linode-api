 ...
 */
class LKENodePool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKENodePool';
    ...
    protected static $openAPITypes = [
        'autoscaler' => '\ZoneWatcher\LinodeApiV4\Model\LKENodePoolAutoscaler',
        'type' => 'string',
        'count' => 'int',
        'disks' => '\ZoneWatcher\LinodeApiV4\Model\LKENodePoolDisks[]',
        'id' => 'int',
        'nodes' => '\ZoneWatcher\LinodeApiV4\Model\LKENodeStatus[]',
        'tags' => 'string[]'
    ];
    ...
    {
        $this->container['autoscaler'] = $data['autoscaler'] ?? null;
     ...
     * Gets autoscaler
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LKENodePoolAutoscaler|null
     */
    public function getAutoscaler()
    {
        return $this->container['autoscaler'];
    }

    /**
     * Sets autoscaler
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LKENodePoolAutoscaler|null $autoscaler autoscaler
     *
     * @return self
     */
    public function setAutoscaler($autoscaler)
    {
        $this->container['autoscaler'] = $autoscaler;
     ...
     * Sets type
     *
     * @param string|null $type The Linode Type for all of the nodes in the Node Pool.
     *
     * @return self
     */
     ...
     * Sets count
     *
     * @param int|null $count The number of nodes in the Node Pool.
     *
     * @return self
     */
    public function setCount($count)
    {
        ...
        if (!is_null($count) && ($count > 100)) {
            throw new \InvalidArgumentException('invalid value for $count when calling LKENodePool., must be smaller than or equal to 100.');
        }
        if (!is_null($count) && ($count < 1)) {
            throw new \InvalidArgumentException('invalid value for $count when calling LKENodePool., must be bigger than or equal to 1.');
        }
     ...
     * Gets disks
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LKENodePoolDisks[]|null
     */
     ...
     * Sets disks
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LKENodePoolDisks[]|null $disks This Node Pool's custom disk layout.
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param int|null $id This Node Pool's unique ID.
     *
     * @return self
     */
     ...
     * Gets nodes
     *
     * @return \ZoneWatcher\LinodeApiV4\Model\LKENodeStatus[]|null
     */
     ...
     * Sets nodes
     *
     * @param \ZoneWatcher\LinodeApiV4\Model\LKENodeStatus[]|null $nodes Status information for the Nodes which are members of this Node Pool. If a Linode has not been provisioned for a given Node slot, the instance_id will be returned as null.
     *
     * @return self
     */
