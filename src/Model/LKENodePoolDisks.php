...
/**
 * LKENodePoolDisks Class Doc Comment
 *
 * @category Class
 ...
 */
class LKENodePoolDisks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LKENodePool_disks';
     ...
     * Sets size
     *
     * @param int|null $size The size of this custom disk partition in MB.    * The size of this disk partition must not exceed the capacity of the node's plan type.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type This custom disk partition's filesystem type.
     *
     * @return self
     */
