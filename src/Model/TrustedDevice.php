 ...
 */
class TrustedDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'last_authenticated' => 'setLastAuthenticated',
        'last_remote_addr' => 'setLastRemoteAddr'
    ];
    ...
    protected static $getters = [
        ...
        'last_authenticated' => 'getLastAuthenticated',
        'last_remote_addr' => 'getLastRemoteAddr'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_authenticated'] = $data['last_authenticated'] ?? null;
        $this->container['last_remote_addr'] = $data['last_remote_addr'] ?? null;
    }
     ...
     * Sets id
     *
     * @param int|null $id The unique ID for this TrustedDevice
     *
     * @return self
     */
     ...
     * Sets created
     *
     * @param \DateTime|null $created When this Remember Me session was started.  This corresponds to the time of login with the \"Remember Me\" box checked.
     *
     * @return self
     */
     ...
     * Sets expiry
     *
     * @param \DateTime|null $expiry When this TrustedDevice session expires.  Sessions typically last 30 days.
     *
     * @return self
     */
     ...
     * Sets user_agent
     *
     * @param string|null $user_agent The User Agent of the browser that created this TrustedDevice session.
     *
     * @return self
     */
    ...
    /**
     * Gets last_authenticated
     *
     * @return \DateTime|null
     */
    public function getLastAuthenticated()
    {
        return $this->container['last_authenticated'];
    }

    /**
     * Sets last_authenticated
     *
     * @param \DateTime|null $last_authenticated The last time this TrustedDevice was successfully used to authenticate to <a target=\"_top\" href=\"https://login.linode.com\">login.linode.com</a>.
     *
     * @return self
     */
    public function setLastAuthenticated($last_authenticated)
    {
        $this->container['last_authenticated'] = $last_authenticated;

        return $this;
    }

    /**
     * Gets last_remote_addr
     *
     * @return string|null
     */
    public function getLastRemoteAddr()
    {
        return $this->container['last_remote_addr'];
    }

    /**
     * Sets last_remote_addr
     *
     * @param string|null $last_remote_addr The last IP Address to successfully authenticate with this TrustedDevice.
     *
     * @return self
     */
    public function setLastRemoteAddr($last_remote_addr)
    {
        $this->container['last_remote_addr'] = $last_remote_addr;
