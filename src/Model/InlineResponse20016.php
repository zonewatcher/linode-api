...
class InlineResponse20016 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['upload_to'] = $data['upload_to'] ?? null;
    ...
    {
        return $this->container['upload_to'];
    }

    /**
     * Sets upload_to
     *
     * @param string|null $upload_to The URL to upload the Image to.
     *
     * @return self
     */
    public function setUploadTo($upload_to)
    {
        $this->container['upload_to'] = $upload_to;
