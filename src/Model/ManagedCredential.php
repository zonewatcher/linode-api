...
/**
 * ManagedCredential Class Doc Comment
 *
 * @category Class
 ...
 */
class ManagedCredential implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagedCredential';
    ...
    protected static $setters = [
        'id' => 'setId',
        'label' => 'setLabel',
        'last_decrypted' => 'setLastDecrypted'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'label' => 'getLabel',
        'last_decrypted' => 'getLastDecrypted'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['last_decrypted'] = $data['last_decrypted'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['label']) && (mb_strlen($this->container['label']) > 75)) {
            $invalidProperties[] = "invalid value for 'label', the character length must be smaller than or equal to 75.";
        }
        ...
        if (!is_null($this->container['label']) && !preg_match("/[a-zA-Z0-9-_ \\.]{2,75}/", $this->container['label'])) {
            $invalidProperties[] = "invalid value for 'label', must be conform to the pattern /[a-zA-Z0-9-_ \\.]{2,75}/.";
        }
     ...
     * Sets id
     *
     * @param int|null $id This Credential's unique ID.
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label The unique label for this Credential. This is for display purposes only.
     *
     * @return self
     */
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 75)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ManagedCredential., must be smaller than or equal to 75.');
        }
        if (!is_null($label) && (mb_strlen($label) < 2)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ManagedCredential., must be bigger than or equal to 2.');
        }
        if (!is_null($label) && (!preg_match("/[a-zA-Z0-9-_ \\.]{2,75}/", $label))) {
            throw new \InvalidArgumentException("invalid value for $label when calling ManagedCredential., must conform to the pattern /[a-zA-Z0-9-_ \\.]{2,75}/.");
        }
     ...
     */
    public function getLastDecrypted()
    {
        return $this->container['last_decrypted'];
    }

    /**
     * Sets last_decrypted
     *
     * @param \DateTime|null $last_decrypted The date this Credential was last decrypted by a member of Linode special forces.
     *
     * @return self
     */
    public function setLastDecrypted($last_decrypted)
    {
        $this->container['last_decrypted'] = $last_decrypted;
