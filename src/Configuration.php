...
namespace ZoneWatcher\LinodeApiV4;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.linode.com/v4';
    ...
    {
        $report  = 'PHP SDK (ZoneWatcher\LinodeApiV4) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 4.107.0' . PHP_EOL;
